...
// ── Data: Quick Facts ─────────────────────────────────────────
const quickFacts = [
  { icon: "🏛️", label: "Capital", value: "Athens" },
  { icon: "💶", label: "Currency", value: "EUR (€ / Euro)" },
  { icon: "🗣️", label: "Language", value: "Greek & English" },
  { icon: "☀️", label: "Weather", value: "Mediterranean (Sunny & Mild)" },
  { icon: "🎓", label: "Top Intakes", value: "September & February" },
];

// ── Data: Section Navigation ──────────────────────────────────
const tabsData = [
  { id: "overview", icon: "🏛️", label: "Why Greece?" },
  { id: "institutions", icon: "🏫", label: "Top Universities" },
...
//  GREECE MASTER PAGE
// ═══════════════════════════════════════════════════════════════
export default function CountryGreecePage() {
  useEffect(() => { document.title = "Study in Greece 2026 — Student Visa, Universities & Scholarships | Edification Overseas"; }, []);
        ...
        <div ref={heroRef.ref} className="hero-inner" style={{ maxWidth: "1280px", width: "100%", margin: "0 auto", padding: "20px 24px 60px", position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div className="hero-left-col" style={{ flex: "1 1 550px" }}>
            ...
            <p style={{
              ...
              Your affordable gateway to Europe. A <strong>Greece Study Visa</strong> provides Indian students with high-quality, English-taught education, extremely low living costs, and full access to the <strong>Schengen Zone</strong>. It is the perfect destination for Business, Tourism, and globally recognized Maritime studies.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px", aspectRatio: "1/1", animation: "float1 6s infinite ease-in-out" }}>
              <Image 
                src="/images/monuments/greece.png" 
                alt="Greece Monument" 
                fill 
            ...
            <div style={{ position: "absolute", top: "10%", right: "10%", width: "90px", height: "90px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", zIndex: 9, animation: "float2 7s infinite reverse", overflow: "hidden", boxShadow: "0 16px 40px rgba(0,0,0,0.3)" }}>
               <Image src="/images/flags/gr.png" alt="Greece Flag" fill style={{ objectFit: "cover" }} />
            </div>
            ...
            <div style={{ position: "absolute", bottom: "60px", right: "0px", zIndex: 3, animation: "float1 7s infinite reverse" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                <span style={{ fontSize: "20px" }}>💶</span>
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontSize: "10px", color: "#07CBEB", textTransform: "uppercase", fontWeight: 800 }}>Cost of Living</span>
        ...
        <div className="content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#022C45", margin: 0, letterSpacing: "-0.5px" }}>
              Your Complete Guide to Education in Greece
            </h2>
          </div>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div id="overview" className="scroll-section">
              <h2>Why Study in Greece? The European Advantage</h2>
              <p>Greece is an incredible destination for Indian students looking to enter Europe without the heavy financial burden of Western countries. With a rapidly modernizing education sector, a <strong>Greek Study Visa</strong> grants you high-quality English-taught degrees, an unbeatable Mediterranean lifestyle, and full access to travel and network across the Schengen Zone.</p>
              
              <h3>Key Advantages of Education in Greece</h3>
              <div className="info-grid">
                <div className="info-card">
                  <h4>💰 Highly Cost-Effective</h4>
                  <p>Experience European standards of education and infrastructure at a fraction of the tuition and living costs compared to the UK or Germany.</p>
                </div>
                <div className="info-card">
                  <h4>🌍 Full Schengen Access</h4>
                  <p>As a member of the Schengen zone, your Greek student residence permit allows you to easily travel to 27 other European countries without a separate visa.</p>
                </div>
                <div className="info-card">
                  <h4>🚫 Flexible English Rules</h4>
                  <p>While public universities may require IELTS, many top private colleges and international branch campuses accept a Medium of Instruction (MOI) letter.</p>
                </div>
                <div className="info-card">
                  <h4>☀️ Incredible Lifestyle</h4>
                  <p>Ranked as one of the safest and most culturally rich countries in the world, Greece boasts a beautiful Mediterranean climate and welcoming locals.</p>
                </div>
              </div>
            </div>
            ...
            <div id="institutions" className="scroll-section">
              ...
              <p>Greece offers a robust mix of prestigious Public Universities and highly dynamic Private Colleges that partner with UK and US institutions to offer dual degrees.</p>
              
              <h3>Top Public Universities</h3>
              <p>These historic institutions are internationally ranked and offer select English-taught programs for international students:</p>
              <div className="course-tags">
                <span className="course-tag-blue">🏛️ National and Kapodistrian University of Athens</span>
                <span className="course-tag-blue">🏛️ Aristotle University of Thessaloniki</span>
                <span className="course-tag-blue">🏛️ Athens University of Economics and Business</span>
                <span className="course-tag-blue">🏛️ National Technical University of Athens</span>
                <span className="course-tag-blue">🏛️ University of Crete</span>
              </div>

              <h3>Top Private Colleges & Business Schools</h3>
              <p>These institutions are extremely popular among Indian students for their flexible admissions, English-medium programs, and UK university affiliations:</p>
              <div className="course-tags">
                <span className="course-tag">🏫 ALBA Graduate Business School</span>
                <span className="course-tag">🏫 Mediterranean College</span>
                <span className="course-tag">🏫 City Unity College</span>
                <span className="course-tag">🏫 BCA College</span>
                <span className="course-tag">🏫 Metropolitan College</span>
                <span className="course-tag">🏫 Athens Tech College</span>
              </div>
              
              <h3>Estimated Financial Requirements</h3>
              <p>Greece is known for being highly budget-friendly, making it easier to show the required funds for visa approval.</p>
              
              <div className="stat-grid">
                <div className="stat-card">
                  <div className="stat-value">€ 4k - € 7k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Bachelors Degrees)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">€ 6k - € 10k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Masters Programs)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">€ 400 - € 700</div>
                ...
                <div className="stat-card" style={{ background: "#fff5ee", borderColor: "rgba(241,97,1,0.3)" }}>
                  <div className="stat-value" style={{ color: "#F16101" }}>€ 5k - € 7k</div>
                  <div className="stat-label">Required Bank Balance<br/>(Show Money / Funds)</div>
                </div>
              </div>
            </div>
            ...
            <div id="courses" className="scroll-section">
              <h2>High-Demand Courses in Greece</h2>
              <p>Because of its strategic geographic location and massive shipping and tourism industries, Greece excels in specific educational domains that guarantee high employability.</p>
              
              <h3>Maritime Studies & Shipping Management</h3>
              <p>Greece controls the largest merchant fleet in the world. Studying maritime and shipping logistics here places you at the global center of the industry.</p>
              <div className="course-tags">
                <span className="course-tag">🚢 Shipping Management</span>
                <span className="course-tag">⚓ Maritime Law & Logistics</span>
                <span className="course-tag">📦 Global Supply Chain</span>
              </div>

              <h3>Hospitality, Tourism & Culinary Arts</h3>
              <p>As a premier European tourist destination, Greece offers programs that frequently feature paid internships in luxury resorts.</p>
              <div className="course-tags">
                <span className="course-tag">🏨 Hospitality Management</span>
            ...
            <div id="admissions" className="scroll-section">
              <h2>Navigating the Greece Visa Process</h2>
              <p>Indian students must apply for a <strong>National Visa (Type D)</strong> for studies. After arriving in Greece, this visa is converted into a Greek Residence Permit.</p>
              
              <h3>The Step-by-Step Visa Process</h3>
              <div className="timeline">
                <div className="timeline-step">
                  <div className="step-num">1</div>
                  <div className="step-content"><strong>Secure Offer Letter:</strong> Submit your academics, valid English scores (or MOI), and passport to receive an acceptance letter from a Greek institution.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">2</div>
                  <div className="step-content"><strong>Document Apostille:</strong> You must get your essential documents (PCC, Medical Certificate, Academics) officially Apostilled by the MEA in India.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">3</div>
                  <div className="step-content"><strong>Prepare Financials:</strong> Ensure your bank account reflects sufficient living funds (approx €5,000 - €7,000) and pay your initial tuition deposit.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">4</div>
                  <div className="step-content"><strong>Embassy Submission & Interview:</strong> Submit your physical visa file to the Greek Embassy or VFS Global. You may be called for a short interview to verify your study intentions.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">5</div>
                  <div className="step-content"><strong>Arrival & Residence Permit:</strong> Travel to Greece on your Type D visa. Within your first 40 days, apply for your Greek Residence Permit to gain full legal status.</div>
                </div>
              </div>
            </div>
            ...
            <div id="documents" className="scroll-section">
              ...
              <p>For European visas, having your documents properly legalized is the most critical step. Documents must be Apostilled by the Ministry of External Affairs (MEA) in India.</p>
              
              <h3>Required Visa Documents</h3>
              <ul className="doc-list">
                <li>Valid Passport (Valid for at least 3 months beyond intended stay)</li>
                <li>Official Acceptance Letter from the Greek Institution</li>
                <li><strong>Original Police Clearance Certificate (PCC)</strong> (Apostilled)</li>
                <li><strong>Original Medical Fitness Certificate</strong> (Apostilled)</li>
                <li>Proof of Funds (Bank statements, Sponsor letter, ITRs)</li>
                <li>Comprehensive Travel & Medical Insurance</li>
                <li>All Academic Transcripts & Degrees (Apostilled)</li>
                <li>Valid IELTS/PTE Score OR MOI Letter (If accepted by the college)</li>
              </ul>
            </div>
            ...
            <div id="careers" className="scroll-section">
              ...
              <p>Greece provides solid opportunities to gain European work experience, particularly in the service, maritime, and business sectors.</p>
              
              <h3>Part-Time Work During Studies</h3>
              <p>International students holding a valid Greek residence permit for studies are legally permitted to work part-time for up to <strong>20 hours per week</strong> during the academic semester, allowing you to manage your living expenses.</p>

              <h3>Post-Study Work Pathways</h3>
              <p>While Greece does not have an automatic, unconditional "PSW Visa" like the UK, international students who secure an employment contract before their student residence permit expires can easily apply to convert their status to a Greek Work Permit, allowing them to settle in Europe.</p>
            </div>
            ...
            <div id="faqs" className="scroll-section">
              ...
              <div className="faq-card">
                <h4>Is IELTS strictly mandatory for Greece?</h4>
                <p>It depends on the institution. While highly ranked public universities usually require an IELTS or TOEFL score, many private colleges and international branch campuses will waive the requirement if you provide a Medium of Instruction (MOI) letter proving you studied in English.</p>
              </div>
              
              <div className="faq-card">
                <h4>What does "Apostille" mean?</h4>
                <p>An Apostille is an official certification from the Indian government (Ministry of External Affairs) that verifies your documents (like your Police Clearance or Medical) are genuine so they can be legally recognized by the Greek government and embassy.</p>
              </div>

              <div className="faq-card">
                <h4>Can I travel to other European countries while studying?</h4>
                <p>Yes. Once you arrive in Greece and receive your official Greek Residence Permit, you have the legal right to travel freely across all 27 Schengen countries (including France, Germany, Italy, Malta, etc.) without needing any additional tourist visas.</p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#4B5563", margin: 0, maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
              Every country offers unique opportunities. Compare Greece with other top global study destinations to find your perfect fit.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, flex: "1 1 400px" }}>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 900, color: "white", letterSpacing: "-0.5px", margin: "0 0 16px" }}>
                Ready to Apply to Greece?
              </h2>
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.6, maxWidth: "480px" }}>
                Connect with our certified experts to secure your admission letter, complete your Apostille document file, and successfully secure your Greek Study Visa.
              </p>
            </div>
