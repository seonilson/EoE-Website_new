...
// ── Data: Quick Facts ─────────────────────────────────────────
const quickFacts = [
  { icon: "🏛️", label: "Capital", value: "Moscow" },
  { icon: "💵", label: "Currency", value: "RUB (Russian Ruble)" },
  { icon: "🗣️", label: "Language", value: "Russian & English" },
...
const tabsData = [
  { id: "overview", icon: "🌍", label: "Why Russia?" },
...
//  RUSSIA MASTER PAGE
// ═══════════════════════════════════════════════════════════════
export default function CountryRussiaPage() {
  useEffect(() => { document.title = "Study in Russia 2026 — Student Visa, Universities & Scholarships | Edification Overseas"; }, []);
        ...
        <div ref={heroRef.ref} className="hero-inner" style={{ maxWidth: "1280px", width: "100%", margin: "0 auto", padding: "20px 24px 60px", position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div className="hero-left-col" style={{ flex: "1 1 550px" }}>
            ...
            <p style={{
              ...
              Your pathway to global success. A <strong>Russian Study Visa</strong> is highly popular for Indian students seeking affordable <strong>MBBS degrees</strong> and the <strong>12-Month Russian Language Preparatory Course</strong>. Enjoy a fast-tracked process with <strong>no IELTS/PTE</strong> and <strong>no embassy interviews</strong> required.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px", aspectRatio: "1/1", animation: "float1 6s infinite ease-in-out" }}>
              <Image 
                src="/images/monuments/russia.png" 
                alt="Russia Monument" 
                fill 
            ...
            <div style={{ position: "absolute", top: "10%", right: "10%", width: "90px", height: "90px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", zIndex: 9, animation: "float2 7s infinite reverse", overflow: "hidden", boxShadow: "0 16px 40px rgba(0,0,0,0.3)" }}>
               <Image src="/images/flags/ru.png" alt="Russia Flag" fill style={{ objectFit: "cover" }} />
            </div>
            ...
            <div style={{ position: "absolute", top: "40px", left: "0px", zIndex: 3, animation: "float2 5s infinite" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  <span style={{ fontSize: "14px", fontWeight: 800, color: "#ffffff" }}>No Interview</span>
                </div>
              </div>
            </div>
        ...
        <div className="content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#022C45", margin: 0, letterSpacing: "-0.5px" }}>
              Your Complete Guide to Education in Russia
            </h2>
          </div>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div id="overview" className="scroll-section">
              <h2>Why Study in Russia? Top Destination for Indian Students</h2>
              <p>Russia has long been a highly preferred destination for Indian students, offering world-class education at extremely affordable rates. A <strong>Russian Study Visa</strong> provides a straightforward, highly reliable pathway to securing globally recognized degrees, especially in the medical and engineering fields.</p>
              
              <h3>Key Advantages of Education in Russia</h3>
              <div className="info-grid">
                <div className="info-card">
                  <h4>🩺 Premier Medical Education</h4>
                  <p>Russian medical universities are consistently ranked among the best globally and are fully recognized by international medical councils.</p>
                </div>
                <div className="info-card">
                  <h4>🚫 No IELTS/PTE Required</h4>
                  <p>Admissions are highly flexible. Students can secure admission and process their visa without any English proficiency exams.</p>
                </div>
                <div className="info-card">
                  <h4>⚡ No Embassy Interviews</h4>
                  <p>The visa process is incredibly smooth. Once you receive your official University Invitation Letter, the visa is granted without an interview.</p>
                </div>
                <div className="info-card">
                  <h4>🎓 The 12-Month Language Pathway</h4>
                  <p>Complete a dedicated 1-year Russian Language Preparatory Course to easily transition into any Bachelor's or Master's program.</p>
                </div>
              </div>
            </div>
            ...
            <div id="institutions" className="scroll-section">
              <h2>Top Universities in Russia</h2>
              <p>Russia hosts some of the world's most historic and prestigious universities, offering excellent infrastructure and highly subsidized tuition fees for international students.</p>
              
              <h3>Top Medical & General Universities</h3>
              <p>These universities are highly sought after by Indian students for their English-medium MBBS and engineering programs:</p>
              <div className="course-tags">
                <span className="course-tag-blue">🏛️ Lomonosov Moscow State University</span>
                <span className="course-tag-blue">🏛️ Sechenov University (Medical)</span>
                <span className="course-tag-blue">🏛️ Saint Petersburg State University</span>
                <span className="course-tag-blue">🏛️ Kazan Federal University</span>
                <span className="course-tag-blue">🏛️ Peoples' Friendship University (RUDN)</span>
                <span className="course-tag-blue">🏛️ Tomsk State University</span>
                <span className="course-tag-blue">🏛️ Ural Federal University</span>
              </div>

              <h3>Language & Innovation Colleges</h3>
              <p>These institutions are famous for offering the mandatory and highly effective 12-month Russian Language Preparatory courses:</p>
              <div className="course-tags">
                <span className="course-tag">🏫 Moscow State Linguistic University</span>
                <span className="course-tag">🏫 Moscow International Innovation College</span>
              </div>
              
              <h3>Estimated Financial Requirements</h3>
              <p>Due to heavy government subsidies, studying in Russia is highly cost-effective, making it a brilliant choice for Indian families.</p>
              ...
              <div className="stat-grid">
                ...
                <div className="stat-card">
                  <div className="stat-value">$2.5k - $5k</div>
            ...
            <div id="courses" className="scroll-section">
              <h2>High-Demand Courses in Russia</h2>
              <p>Russia offers specialized programs that draw thousands of international students every year, with clear pathways to global careers.</p>
              
              <div className="content-highlight">
                <p><strong>The 12-Month Language Pathway:</strong> This 12-month immersive program is the most popular pathway. It teaches students the Russian language from scratch, allowing them to smoothly enter complete Bachelor’s or Master’s degrees taught in Russian, which are often significantly cheaper than English-taught programs.</p>
              </div>

              <h3>Medicine & Healthcare</h3>
              <p>Russia is world-renowned for its highly affordable and globally recognized medical degrees.</p>
              <div className="course-tags">
            ...
            <div id="admissions" className="scroll-section">
              <h2>Navigating the Russian Student Visa</h2>
              <p>The Russian Student Visa process is very distinct. The most critical component is securing the official <strong>Invitation Letter</strong> from the Ministry of Interior, rather than just an offer letter from the university.</p>
              
              <h3>The Step-by-Step Visa Process</h3>
              <div className="timeline">
                <div className="timeline-step">
                  <div className="step-num">1</div>
                  <div className="step-content"><strong>University Admission:</strong> Submit your basic academic documents and passport to secure your university seat.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">2</div>
                  <div className="step-content"><strong>Official Invitation Letter:</strong> The university applies to the General Directorate of Migration (GUVM) in Russia to issue your official Electronic Invitation Letter. This takes about 3 to 5 weeks.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">3</div>
                  <div className="step-content"><strong>Medical Tests in India:</strong> While waiting for the invitation, complete the mandatory HIV/AIDS test at a recognized lab in India.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">4</div>
                  <div className="step-content"><strong>Visa Filing (No Interview):</strong> Submit your passport, invitation letter, and HIV report to the Russian Visa Application Centre (VFS) in India. The visa is stamped without any embassy interview.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">5</div>
                  <div className="step-content"><strong>Migration Registration:</strong> Travel to Russia. Within 7 days of arrival, the university will register your visa with the local migration authorities.</div>
                </div>
              </div>
            </div>
            ...
            <div id="documents" className="scroll-section">
              ...
              <p>The Russian visa process relies on specific, original documentation. Missing medical reports will result in visa delays.</p>
              
              <h3>Required Admission & Visa Documents</h3>
              <ul className="doc-list">
                <li>Original Passport (Valid for at least 18 months from the visa issue date)</li>
                <li>Original Official Invitation Letter (issued by GUVM/Ministry of Interior)</li>
                ...
                <li>Completed Russian Visa Application Form</li>
              </ul>
            </div>

            {/* CHAPTER 6: CAREERS */}
            <div id="careers" className="scroll-section">
              <h2>Work Rights and Post-Study Opportunities</h2>
              <p>Russia has recently updated its policies to make it easier for international students to support themselves and build careers.</p>
              
              <h3>Part-Time Work During Studies</h3>
              <p>International students studying full-time at state-accredited universities in Russia are legally allowed to work part-time without needing a separate work permit. This allows students to gain valuable local experience and manage their living expenses.</p>

              <h3>Post-Study Work & Migration</h3>
              <p>Upon completing a degree from a Russian state university, international graduates can apply for specialized post-study work permits or the Temporary Residence Permit (TRP) for education purposes (RVPO), making the transition into the Russian workforce much smoother.</p>
            </div>
            ...
            <div id="faqs" className="scroll-section">
              ...
              <div className="faq-card">
                <h4>Is the Russian Language Course mandatory?</h4>
                <p>If you choose to enroll in a degree program taught in Russian (which is often much cheaper), the 12-month preparatory course is mandatory. However, many universities also offer direct entry into English-medium MBBS and Engineering programs.</p>
              </div>
              
              <div className="faq-card">
                <h4>Is an IELTS or PTE score required for the visa?</h4>
                <p>No. Neither the Russian universities nor the Russian Embassy require IELTS, PTE, or TOEFL scores for admission or visa processing.</p>
              </div>

              <div className="faq-card">
                <h4>Will I face an embassy interview for the Russian Student Visa?</h4>
                <p>No. Unlike the USA or UK, the Russian student visa process is document-based. Once you have the official Invitation Letter from the Ministry, your visa is stamped based on your submitted file without a personal interview.</p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#4B5563", margin: 0, maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
              Every country offers unique opportunities. Compare Russia with other top global study destinations to find your perfect fit.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, flex: "1 1 400px" }}>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 900, color: "white", letterSpacing: "-0.5px", margin: "0 0 16px" }}>
                Ready to Apply to Russia?
              </h2>
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.6, maxWidth: "480px" }}>
                Connect with our certified experts to secure your admission letter, obtain your official Ministry Invitation, and confidently lodge your Russian Study Visa.
              </p>
            </div>
