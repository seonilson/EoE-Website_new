...
// ── Data: Quick Facts ─────────────────────────────────────────
const quickFacts = [
  { icon: "🏛️", label: "Capital", value: "Chișinău" },
  { icon: "💵", label: "Currency", value: "MDL (Moldovan Leu)" },
  { icon: "🗣️", label: "Language", value: "Romanian & English" },
  { icon: "❄️", label: "Weather", value: "Continental (Warm Summer, Cold Winter)" },
  { icon: "🎓", label: "Top Intakes", value: "September & February" },
];

// ── Data: Section Navigation ──────────────────────────────────
const tabsData = [
  { id: "overview", icon: "🌍", label: "Why Moldova?" },
  { id: "institutions", icon: "🏛️", label: "Top Universities" },
  { id: "courses", icon: "🎯", label: "MBBS & Courses" },
...
//  MOLDOVA MASTER PAGE
// ═══════════════════════════════════════════════════════════════
export default function CountryMoldovaPage() {
  useEffect(() => { document.title = "Study in Moldova 2026 — Student Visa, Medical Universities | Edification Overseas"; }, []);
        ...
        <div ref={heroRef.ref} className="hero-inner" style={{ maxWidth: "1280px", width: "100%", margin: "0 auto", padding: "20px 24px 60px", position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div className="hero-left-col" style={{ flex: "1 1 550px" }}>
            ...
            <p style={{
              ...
              Your premier gateway to European medical excellence. A <strong>Moldova Study Visa</strong> offers Indian students access to highly affordable, <strong>NMC-approved MBBS degrees</strong> taught entirely in English, featuring a straightforward admission process with <strong>no IELTS required</strong>.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px", aspectRatio: "1/1", animation: "float1 6s infinite ease-in-out" }}>
              <Image 
                src="/images/monuments/moldova.png" 
                alt="Moldova Monument" 
                fill 
            ...
            <div style={{ position: "absolute", top: "10%", right: "10%", width: "90px", height: "90px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", zIndex: 9, animation: "float2 7s infinite reverse", overflow: "hidden", boxShadow: "0 16px 40px rgba(0,0,0,0.3)" }}>
               <Image src="/images/flags/md.png" alt="Moldova Flag" fill style={{ objectFit: "cover" }} />
            </div>
            ...
            <div style={{ position: "absolute", top: "40px", left: "0px", zIndex: 3, animation: "float2 5s infinite" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontSize: "10px", color: "#07CBEB", textTransform: "uppercase", fontWeight: 800 }}>Admissions</span>
            ...
            <div style={{ position: "absolute", bottom: "60px", right: "0px", zIndex: 3, animation: "float1 7s infinite reverse" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                <span style={{ fontSize: "20px" }}>🩺</span>
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontSize: "10px", color: "#07CBEB", textTransform: "uppercase", fontWeight: 800 }}>Medical Hub</span>
                  <span style={{ fontSize: "14px", fontWeight: 800, color: "#ffffff" }}>NMC Approved</span>
                </div>
              </div>
            </div>
        ...
        <div className="content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#022C45", margin: 0, letterSpacing: "-0.5px" }}>
              Your Complete Guide to Education in Moldova
            </h2>
          </div>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div id="overview" className="scroll-section">
              <h2>Why Study in Moldova? The European Medical Gateway</h2>
              <p>Moldova has rapidly emerged as one of the most attractive and cost-effective destinations for Indian students aspiring to become doctors. Located in Eastern Europe, a <strong>Moldova Student Visa</strong> offers a completely secure environment, robust European medical standards, and degrees strictly aligned with global medical councils.</p>
              
              <h3>Key Advantages of Education in Moldova</h3>
              <div className="info-grid">
                <div className="info-card">
                  <h4>🩺 NMC & WHO Approved</h4>
                  <p>Medical degrees from top Moldovan universities are fully recognized by the National Medical Commission (India) and the World Health Organization.</p>
                </div>
                <div className="info-card">
                  <h4>💰 Affordable European Education</h4>
                  <p>Experience high-quality European clinical exposure and infrastructure at a fraction of the cost of studying in the UK or Western Europe.</p>
                </div>
                <div className="info-card">
                  <h4>🚫 No IELTS Required</h4>
                  <p>The admissions process is extremely straightforward. Indian students do not need to clear IELTS or PTE to secure a seat.</p>
                </div>
                <div className="info-card">
                  <h4>🛡️ High Safety Standards</h4>
                  <p>Moldova is known for its peaceful, welcoming society, offering a highly secure environment for both male and female international students.</p>
                </div>
              </div>
            </div>
            ...
            <div id="institutions" className="scroll-section">
              ...
              <p>Moldova is home to specialized state universities that are internationally accredited and highly experienced in hosting and training Indian medical students.</p>
              
              <h3>The Premier Medical Choice</h3>
              <p>This state university is the absolute primary destination for Indian students pursuing an MBBS degree in Moldova:</p>
              <div className="course-tags">
                <span className="course-tag-blue">🏛️ Nicolae Testemițanu State University of Medicine and Pharmacy (SUMP)</span>
              </div>

              <h3>Top General & Technical Universities</h3>
              <p>Highly reputed institutions offering excellent programs in Business, Humanities, and Engineering:</p>
              <div className="course-tags">
                <span className="course-tag">🏫 Technical University of Moldova</span>
                <span className="course-tag">🏫 Moldova State University</span>
                <span className="course-tag">🏫 Free International University of Moldova (ULIM)</span>
                <span className="course-tag">🏫 Academy of Economic Studies of Moldova (ASEM)</span>
              </div>
              
              <h3>Estimated Financial Requirements</h3>
              <p>Studying in Moldova provides excellent value for money, combining affordable tuition fees with a very low cost of living compared to the rest of Europe.</p>
              
              <div className="stat-grid">
                <div className="stat-card">
                  <div className="stat-value">€4k - €5.5k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(MBBS Medical Degree)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">€2k - €3.5k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Bachelors & Masters)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">€250 - €400</div>
                ...
                <div className="stat-card" style={{ background: "#fff5ee", borderColor: "rgba(241,97,1,0.3)" }}>
                  ...
                  <div className="stat-label">Required Bank Balance<br/>(Show Money)</div>
                </div>
              </div>
            </div>
            ...
            <div id="courses" className="scroll-section">
              <h2>High-Demand Courses in Moldova</h2>
              <p>While Moldova offers a variety of general programs, it is universally recognized in the Indian market as a powerhouse for medical education.</p>
              
              <h3>Medicine & Healthcare (MBBS)</h3>
              <p>The 6-Year MD (equivalent to MBBS in India) is the flagship program. It is fully taught in English and features early clinical exposure in European hospitals.</p>
              <div className="course-tags">
              ...
              <h3>Business & Information Technology</h3>
              <p>Moldova's growing IT sector and central European location make it an interesting option for tech and corporate careers.</p>
              <div className="course-tags">
                <span className="course-tag">💻 Computer Science & IT</span>
                <span className="course-tag">📈 Business Administration</span>
                <span className="course-tag">⚙️ Technical Engineering</span>
              </div>
            </div>

            {/* CHAPTER 4: ADMISSIONS & VISAS */}
            <div id="admissions" className="scroll-section">
              <h2>Navigating the Moldovan Visa Process</h2>
              <p>The admission process in Moldova is systematic. Like many Eastern European nations, the critical step is obtaining the official <strong>Invitation Letter</strong> from the Ministry of Internal Affairs/Migration before applying for the visa.</p>
              
              <h3>The Step-by-Step Visa Process</h3>
              <div className="timeline">
                <div className="timeline-step">
                  <div className="step-num">1</div>
                  <div className="step-content"><strong>Offer Letter:</strong> Submit your 10th/12th mark sheets and passport copy. Medical students must submit a valid NEET scorecard to secure an offer letter.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">2</div>
                  <div className="step-content"><strong>Ministry Invitation:</strong> The university submits your documents to the Moldovan Bureau for Migration and Asylum to issue your official Invitation Letter.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">3</div>
                  <div className="step-content"><strong>Visa Application:</strong> Once the Invitation Letter is issued, we apply for your Long Stay (Type D) Student Visa via the Moldovan eVisa portal or embassy.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">4</div>
                  <div className="step-content"><strong>Arrival in Moldova:</strong> Travel to Chișinău. The university will assist with your airport pickup and initial hostel allocation.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">5</div>
                  <div className="step-content"><strong>Residence Permit:</strong> Within a few days of your arrival, you will undergo local medical tests and apply for your Temporary Residence Permit (TRP) card.</div>
                </div>
              </div>
            </div>
            ...
            <div id="documents" className="scroll-section">
              ...
              <p>Moldova requires specific documents to be authenticated and translated before submission for the Ministry Invitation and Visa.</p>
              ...
              <ul className="doc-list">
                ...
                <li>Police Clearance Certificate (PCC) with Apostille</li>
                <li>Bank Statement showing required living funds (approx €3,000 - €5,000)</li>
                <li>Official Medical Certificate (HIV/AIDS tests)</li>
            ...
            <div id="careers" className="scroll-section">
              ...
              <p>For medical students, the primary focus is exclusively on completing their rigorous degree to return home or migrate globally.</p>
              
              <div className="content-highlight">
                <p><strong>Part-Time Work Rules:</strong> While international students in Moldova may be permitted to work limited part-time hours, universities heavily advise medical students to focus entirely on their intensive clinical and academic studies, as the cost of living is extremely low.</p>
              </div>

              <h3>Post-Study Medical Pathways</h3>
              <p>Upon graduation, Indian students are awarded an MD degree (equivalent to MBBS). To practice medicine in India, graduates must successfully clear the <strong>FMGE / NEXT exam</strong>. Because Moldovan medical degrees are recognized globally, many students also use them to prepare for the <strong>USMLE (USA)</strong>, <strong>PLAB (UK)</strong>, or to pursue further medical residency inside Europe.</p>
            </div>
            ...
            <div id="faqs" className="scroll-section">
              ...
              <div className="faq-card">
                <h4>Is NEET mandatory to study MBBS in Moldova?</h4>
                <p>Yes. If you are an Indian citizen planning to practice medicine in India after graduation, the National Medical Commission (NMC) strictly mandates that you must have qualified the NEET-UG exam before taking admission abroad.</p>
              </div>

              <div className="faq-card">
                <h4>Are the MBBS programs in Moldova taught in English?</h4>
                <p>Absolutely. The 6-year medical programs for international students at institutions like Nicolae Testemițanu SUMP are taught entirely in English. You will, however, be taught basic Romanian/Russian to help you communicate with local patients during your hospital clinical rotations.</p>
              </div>
              
              <div className="faq-card">
                <h4>Is an IELTS or PTE score required for the visa?</h4>
                <p>No. Moldovan universities and visa authorities do not require IELTS or PTE scores from Indian students. Admissions are evaluated based on your 12th standard science marks and your NEET qualification.</p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#4B5563", margin: 0, maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
              Every country offers unique opportunities. Compare Moldova with other top global study destinations to find your perfect fit.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, flex: "1 1 400px" }}>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 900, color: "white", letterSpacing: "-0.5px", margin: "0 0 16px" }}>
                Ready to Apply to Moldova?
              </h2>
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.6, maxWidth: "480px" }}>
                Connect with our certified experts to secure your medical university seat, obtain your official Ministry Invitation, and confidently lodge your Moldovan Study Visa.
              </p>
            </div>
