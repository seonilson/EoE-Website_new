...
// ── Data: Quick Facts ─────────────────────────────────────────
const quickFacts = [
  { icon: "🏛️", label: "Capital", value: "Nicosia" },
  { icon: "💶", label: "Currency", value: "EUR (Euro)" },
  { icon: "🗣️", label: "Language", value: "English & Greek" },
  { icon: "☀️", label: "Weather", value: "Warm Mediterranean" },
  { icon: "🎓", label: "Top Intakes", value: "Fall (Sep) & Spring (Feb)" },
];

// ── Data: Section Navigation ──────────────────────────────────
const tabsData = [
  { id: "overview", icon: "🌍", label: "Why Cyprus?" },
  { id: "institutions", icon: "🏛️", label: "Universities & Colleges" },
  { id: "courses", icon: "🎯", label: "Top Courses" },
  { id: "admissions", icon: "📝", label: "Visa Process" },
  { id: "documents", icon: "📂", label: "Apostille & Docs" },
...
export default function CountryCyprusPage() {
  ...
  // Smooth Scroll Logic for Content
        ...
        <div ref={heroRef.ref} className="hero-inner" style={{ maxWidth: "1280px", width: "100%", margin: "0 auto", padding: "20px 24px 60px", position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div className="hero-left-col" style={{ flex: "1 1 550px" }}>
            ...
            <p style={{
              ...
              Begin your European journey. A <strong>Cyprus Study Visa</strong> offers Indian students highly affordable tuition, a straightforward visa process, excellent success rates, and universally recognized European degrees with clear English proficiency standards.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px", aspectRatio: "1/1", animation: "float1 6s infinite ease-in-out" }}>
              <Image 
                src="/images/monuments/cyprus.png" 
                alt="Cyprus Monument" 
                fill 
            ...
            <div style={{ position: "absolute", top: "10%", right: "10%", width: "90px", height: "90px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", zIndex: 9, animation: "float2 7s infinite reverse", overflow: "hidden", boxShadow: "0 16px 40px rgba(0,0,0,0.3)" }}>
               <Image src="/images/flags/cy.png" alt="Cyprus Flag" fill style={{ objectFit: "cover" }} />
            </div>
            ...
            <div style={{ position: "absolute", top: "40px", left: "0px", zIndex: 3, animation: "float2 5s infinite" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontSize: "10px", color: "#07CBEB", textTransform: "uppercase", fontWeight: 800 }}>Global Standards</span>
                  <span style={{ fontSize: "14px", fontWeight: 800, color: "#ffffff" }}>English Taught</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ position: "absolute", bottom: "60px", right: "0px", zIndex: 3, animation: "float1 7s infinite reverse" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                <span style={{ fontSize: "20px" }}>💶</span>
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontSize: "10px", color: "#07CBEB", textTransform: "uppercase", fontWeight: 800 }}>Tuition</span>
        ...
        <div className="content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#022C45", margin: 0, letterSpacing: "-0.5px" }}>
              Your Complete Guide to Education in Cyprus
            </h2>
          </div>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div id="overview" className="scroll-section">
              <h2>Why Study in Cyprus? The European Advantage</h2>
              <p>For Indian students, studying in Cyprus provides an exceptional entry point into Europe. It offers a unique combination of high academic standards, low cost of living, and an extremely secure environment. A <strong>Cyprus Study Visa</strong> is an excellent choice for students who want a quality European degree.</p>
              
              <h3>Key Advantages of Education in Cyprus</h3>
              <div className="info-grid">
                <div className="info-card">
                  <h4>💰 Highly Cost-Effective</h4>
                  <p>Experience European standards of education at a fraction of the cost compared to the UK, Germany, or Canada.</p>
                </div>
                <div className="info-card">
                  <h4>📝 IELTS/PTE Required</h4>
                  <p>To maintain high educational standards, Cyprus strictly requires valid IELTS or PTE scores, ensuring a high visa success rate for genuine students.</p>
                </div>
                <div className="info-card">
                  <h4>⏳ Study Gaps Accepted</h4>
                  <p>Institutions are highly accommodating of academic gaps, provided you can show relevant work experience or logical reasons.</p>
                </div>
                <div className="info-card">
                  <h4>☀️ Incredible Lifestyle</h4>
                  <p>Ranked as one of the safest countries in the world, Cyprus boasts a beautiful Mediterranean climate and a welcoming international community.</p>
                </div>
              </div>
            </div>
            ...
            <div id="institutions" className="scroll-section">
              ...
              <p>Cyprus is home to a mix of internationally recognized Public Universities, Private Universities, and specialized Colleges that focus heavily on practical skills and employability.</p>
              
              <h3>Recognized Universities</h3>
              <div className="course-tags">
                <span className="course-tag-blue">🏛️ University of Nicosia</span>
                <span className="course-tag-blue">🏛️ University of Central Lancashire (UCLan Cyprus)</span>
                <span className="course-tag-blue">🏛️ Neapolis University Pafos</span>
                <span className="course-tag-blue">🏛️ University of Limassol</span>
                <span className="course-tag-blue">🏛️ American University of Cyprus</span>
              </div>

              <h3>Top Professional Colleges</h3>
              <p>These institutions are extremely popular choices for international students due to their affordable fees and industry-focused programs:</p>
              <div className="course-tags">
                <span className="course-tag">🏫 City Unity College</span>
                <span className="course-tag">🏫 Alexander College</span>
                <span className="course-tag">🏫 CDA College</span>
                <span className="course-tag">🏫 KES College</span>
                <span className="course-tag">🏫 Ledra College</span>
                <span className="course-tag">🏫 Atlantis College</span>
                <span className="course-tag">🏫 Internapa College</span>
                <span className="course-tag">🏫 Cyprus Academy of Arts</span>
                <span className="course-tag">🏫 College of Tourism & Hotel Management</span>
              </div>
              
              <h3>Estimated Financial Requirements</h3>
              <p>Cyprus is known for being budget-friendly. Tuition fees vary depending on whether you choose a college diploma or a full university degree.</p>
              
              <div className="stat-grid">
                <div className="stat-card">
                  <div className="stat-value">€ 4k - 6k</div>
                  <div className="stat-label">Avg. Tuition<br/>(Colleges/Diplomas)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">€ 7k - 10k</div>
                  <div className="stat-label">Avg. Tuition<br/>(Universities/Bachelors)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">€ 8k - 14k</div>
                  <div className="stat-label">Avg. Tuition<br/>(Masters Programs)</div>
                </div>
                <div className="stat-card">
            ...
            <div id="courses" className="scroll-section">
              <h2>High-Demand Courses in Cyprus</h2>
              <p>Because of its strategic location and massive tourism industry, Cyprus excels in specific educational domains that guarantee high employability upon graduation.</p>
              
              <h3>Hospitality, Tourism & Culinary Arts</h3>
              <p>Cyprus is a premier European tourist destination. Many colleges offer paid internships as part of the curriculum.</p>
              <div className="course-tags">
              ...
              <div className="course-tags">
                ...
                <span className="course-tag">💰 Accounting & Finance</span>
                <span className="course-tag">🌍 International Relations</span>
              </div>
            ...
            <div id="admissions" className="scroll-section">
              <h2>Navigating the Cyprus Visa Process</h2>
              <p>The Cyprus student visa process is unique. In most cases, the institution in Cyprus applies for the visa on your behalf at the Civil Registry and Migration Department (CRMD) in Cyprus, known as the <strong>MINT (Migration) Approval</strong> process.</p>
              
              <h3>The Step-by-Step Admission Process</h3>
              <div className="timeline">
                <div className="timeline-step">
                  <div className="step-num">1</div>
                  <div className="step-content"><strong>Secure Offer Letter:</strong> Submit your academics, valid English scores (IELTS/PTE), and passport to receive a conditional offer.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">2</div>
                  <div className="step-content"><strong>Document Apostille:</strong> You must get your essential documents (PCC, Medical, Bank, Academics) officially Apostilled in India.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">3</div>
                  <div className="step-content"><strong>Fee Transfer:</strong> Pay the required initial tuition fee deposit to the college's official bank account.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">4</div>
                  <div className="step-content"><strong>Visa Filing by College:</strong> Send the hard copies of your Apostilled documents to the college in Cyprus via courier. The college submits them to migration.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">5</div>
                  <div className="step-content"><strong>Visa Approval (Blue Slip):</strong> Once approved by Cyprus migration, you receive a copy of your visa approval to travel.</div>
                </div>
              </div>

              <div className="content-highlight">
                <p>Note: Students may occasionally be called for a brief online or embassy interview to verify their study intentions and English proficiency.</p>
              </div>
            </div>

            {/* CHAPTER 5: DOCUMENTS */}
            <div id="documents" className="scroll-section">
              <h2>Crucial Apostille Document Checklist</h2>
              <p>For Cyprus, having your documents properly legalized is the most critical step. Documents must be Apostilled by the Ministry of External Affairs (MEA) in India.</p>
              
              <h3>Required Apostilled Documents</h3>
              <ul className="doc-list">
                <li>Original Police Clearance Certificate (PCC) from Passport Office</li>
                <li>Original Medical Certificate (HIV, VDRL, Hep B/C, Syphilis, Chest X-Ray)</li>
                <li>Original Bank Statement & Sponsor Letter</li>
                <li>Original Academic Transcripts & Degrees</li>
              </ul>

              <h3>General Admission Checklist</h3>
              <ul className="doc-list">
                <li>Valid Passport (Front & Back)</li>
                <li>Updated Curriculum Vitae (CV)</li>
                <li>Valid IELTS or PTE Score Card</li>
            ...
            <div id="careers" className="scroll-section">
              ...
              <p>Cyprus provides excellent opportunities to gain European work experience, particularly in the service, IT, and business sectors.</p>
              
              <h3>Part-Time Work During Studies</h3>
              <p>International students in Cyprus are legally permitted to work part-time for up to <strong>20 hours per week</strong> during the academic semester, and full-time (38 hours) during official holidays. <em>Note: This right is usually granted after your first 6 months of study.</em></p>

              <h3>Post-Study Work & Internships</h3>
              <p>Many programs, particularly in Hospitality, feature mandatory paid internships during the summer months, allowing students to earn while they learn. Upon graduation, finding a full-time employer willing to sponsor a work permit is the pathway to extending your stay in Europe.</p>
            </div>
            ...
            <div id="faqs" className="scroll-section">
              ...
              <div className="faq-card">
                <h4>Is IELTS strictly mandatory for Cyprus?</h4>
                <p>Yes. To meet university admission standards and fulfill Cyprus immigration requirements, Indian students must provide a valid IELTS or PTE score. This ensures a high visa success rate and demonstrates genuine study intent.</p>
              </div>
              
              <div className="faq-card">
                <h4>What does "Apostille" mean?</h4>
                <p>An Apostille is an official certification from the Indian government (Ministry of External Affairs) that verifies your documents (like your Police Clearance or Medical) are genuine so they can be legally recognized by the Cyprus government.</p>
              </div>

              <div className="faq-card">
                <h4>Does a Cyprus Visa give me access to the Schengen area?</h4>
                <p>Cyprus is an EU member state and is currently in the process of joining the Schengen zone. While a Cyprus student visa itself isn't a direct Schengen visa right now, holding a legal EU residence permit makes obtaining a tourist visa to visit other European countries significantly easier.</p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#4B5563", margin: 0, maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
              Every country offers unique opportunities. Compare Cyprus with other top global study destinations to find your perfect fit.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, flex: "1 1 400px" }}>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 900, color: "white", letterSpacing: "-0.5px", margin: "0 0 16px" }}>
                Ready to Apply to Cyprus?
              </h2>
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.6, maxWidth: "480px" }}>
                Connect with our certified experts to secure your admission letter, complete your Apostille document file, and successfully secure your Cyprus Study Visa.
              </p>
            </div>
