...
// ── Data: Quick Facts ─────────────────────────────────────────
const quickFacts = [
  { icon: "🏛️", label: "Capital", value: "Helsinki" },
  { icon: "💶", label: "Currency", value: "EUR (€ / Euro)" },
  { icon: "🗣️", label: "Language", value: "Finnish, Swedish & English" },
  { icon: "❄️", label: "Weather", value: "Nordic (Cold Winters, Pleasant Summers)" },
  { icon: "🎓", label: "Top Intakes", value: "August/September & January" },
];

// ── Data: Section Navigation ──────────────────────────────────
const tabsData = [
  { id: "overview", icon: "🌍", label: "Why Finland?" },
  { id: "institutions", icon: "🏛️", label: "Unis & Vocational" },
  { id: "courses", icon: "🎯", label: "Top Courses" },
  { id: "admissions", icon: "📝", label: "Migri & Visa Process" },
  { id: "documents", icon: "📂", label: "Documents" },
  { id: "careers", icon: "💼", label: "PSW & PR Pathways" },
...
//  FINLAND MASTER PAGE
// ═══════════════════════════════════════════════════════════════
export default function CountryFinlandPage() {
  useEffect(() => { document.title = "Study in Finland 2026 — Residence Permit, Universities & Costs | Edification Overseas"; }, []);
        ...
        <div ref={heroRef.ref} className="hero-inner" style={{ maxWidth: "1280px", width: "100%", margin: "0 auto", padding: "20px 24px 60px", position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div className="hero-left-col" style={{ flex: "1 1 550px" }}>
            ...
            <p style={{
              ...
              Experience world-leading education and an unparalleled standard of living. A <strong>Finnish Residence Permit</strong> offers Indian students a gateway to Europe's booming tech sectors, highly practical <strong>Vocational Courses</strong>, and an incredibly generous <strong>2-Year Post-Study Work Visa</strong> that puts you on a direct path to Permanent Residency.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px", aspectRatio: "1/1", animation: "float1 6s infinite ease-in-out" }}>
              <Image 
                src="/images/monuments/finland.png" 
                alt="Finland Helsinki Cathedral Monument" 
                fill 
            ...
            <div style={{ position: "absolute", top: "10%", right: "10%", width: "90px", height: "90px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", zIndex: 9, animation: "float2 7s infinite reverse", overflow: "hidden", boxShadow: "0 16px 40px rgba(0,0,0,0.3)" }}>
               <Image src="/images/flags/fi.png" alt="Finland Flag" fill style={{ objectFit: "cover" }} />
            </div>
            ...
            <div style={{ position: "absolute", bottom: "60px", right: "0px", zIndex: 3, animation: "float1 7s infinite reverse" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  <span style={{ fontSize: "14px", fontWeight: 800, color: "#ffffff" }}>Path to PR</span>
                </div>
              </div>
            </div>
        ...
        <div className="content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#022C45", margin: 0, letterSpacing: "-0.5px" }}>
              Your Complete Guide to Education in Finland
            </h2>
          </div>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div id="overview" className="scroll-section">
              <h2>Why Study in Finland? The Hub of Nordic Innovation</h2>
              <p>Finland is globally celebrated not just for being the happiest country in the world, but for possessing one of the most advanced, practical, and highly regarded education systems. For Indian students, a <strong>Finnish Residence Permit</strong> provides a stress-free environment, incredible post-study work rights, and direct pathways to Permanent Residency (PR).</p>
              
              <h3>Key Advantages of Education in Finland</h3>
              <div className="info-grid">
                <div className="info-card">
                  <h4>🌟 Continuous "A" Permit</h4>
                  <p>Students are now granted a continuous "A-Type" residence permit for the entire duration of their studies. This time fully counts towards your Permanent Residency (PR) application.</p>
                </div>
                <div className="info-card">
                  <h4>👩‍❤️‍👨 Dependent Visa Rights</h4>
                  <p>Finland is incredibly family-friendly. Students can bring their spouse and children, and the spouse is granted full, unrestricted work rights from day one.</p>
                </div>
                <div className="info-card">
                  <h4>💼 2-Year Job Seeker Visa</h4>
                  <p>Upon graduation, international students can easily apply for a 2-year post-study work (PSW) permit to secure employment in the booming Finnish job market.</p>
                </div>
                <div className="info-card">
                  <h4>🔧 Vocational Education (VET)</h4>
                  <p>Finland offers highly respected, fast-tracked vocational courses (like Nursing and IT Support) that lead directly to high-paying employment without needing a full degree.</p>
                </div>
              </div>
            </div>
            ...
            <div id="institutions" className="scroll-section">
              <h2>Top Universities & Vocational Institutes</h2>
              <p>Finland divides its higher education into <strong>Research Universities</strong> (highly academic) and <strong>Universities of Applied Sciences (UAS)</strong> (highly practical and industry-linked). Additionally, <strong>Vocational Education and Training (VET)</strong> is heavily promoted by the government.</p>
              
              <h3>Top Public Research Universities</h3>
              <p>These institutions are globally ranked and heavily focused on advanced research and Master's/PhD programs:</p>
              <div className="course-tags">
                <span className="course-tag-blue">🏛️ University of Helsinki</span>
                <span className="course-tag-blue">🏛️ Aalto University</span>
                <span className="course-tag-blue">🏛️ LUT University</span>
                <span className="course-tag-blue">🏛️ Tampere University</span>
                <span className="course-tag-blue">🏛️ University of Oulu</span>
              </div>

              <h3>Top Universities of Applied Sciences (UAS) & VET</h3>
              <p>UAS institutions are massive favorites for Indian students seeking high employability and practical skills:</p>
              <div className="course-tags">
                <span className="course-tag">🏫 Haaga-Helia UAS</span>
                <span className="course-tag">🏫 Metropolia UAS</span>
                <span className="course-tag">🏫 LAB UAS</span>
                <span className="course-tag">🏫 Novia UAS</span>
                <span className="course-tag">🏫 Turku UAS</span>
                <span className="course-tag">🔧 Omnia (Vocational)</span>
                <span className="course-tag">🔧 Riveria (Vocational)</span>
              </div>
              
              <h3>Estimated Financial Requirements</h3>
              <p>The Finnish Immigration Service (Migri) has strict, clear financial requirements to ensure students can support themselves.</p>
              
              <div className="stat-grid">
                <div className="stat-card">
                  <div className="stat-value">€ 8k - € 12k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Bachelors / UAS)</div>
                </div>
                <div className="stat-card">
                ...
                <div className="stat-card" style={{ background: "#fff5ee", borderColor: "rgba(241,97,1,0.3)" }}>
                  <div className="stat-value" style={{ color: "#F16101" }}>€ 9,600</div>
                  <div className="stat-label">Migri Funds Required<br/>(€800/mo for 1 Year)</div>
                </div>
              </div>

              <div className="content-highlight">
                <p><strong>Early Bird Scholarships:</strong> Many Finnish universities offer massive "Early Bird" discounts or performance-based scholarships. If you pay your first-year tuition fee quickly after receiving your offer letter, you can often save anywhere from 10% to 50% on your tuition.</p>
              </div>
            </div>

            {/* CHAPTER 3: COURSES */}
            <div id="courses" className="scroll-section">
              <h2>High-Demand Degrees & Vocational Courses</h2>
              <p>Finland is facing a severe demographic shift and desperately needs skilled workers in both high-tech sectors and essential frontline services.</p>
              
              <h3>Information Technology & CleanTech</h3>
              <p>Finland is the birthplace of Nokia and Linux. The tech industry in cities like Espoo and Helsinki is constantly hiring.</p>
              <div className="course-tags">
                <span className="course-tag">💻 Artificial Intelligence & Data Science</span>
                <span className="course-tag">🌿 Clean Technology & Sustainability</span>
                <span className="course-tag">🎮 Game Design & Software Engineering</span>
              </div>

              <h3>Nursing, Healthcare & Vocational (VET)</h3>
              <p>Finland's aging population has created a massive demand for healthcare workers. Vocational courses are the fastest way to secure long-term employment.</p>
              <div className="course-tags">
                <span className="course-tag">🏥 BSc Nursing (Registered Nurse)</span>
                <span className="course-tag">🔧 Practical Nurse (Lähihoitaja - Vocational)</span>
                <span className="course-tag">🔧 Culinary Arts & Restaurant Services</span>
                <span className="course-tag">🔧 Metalwork & Construction (Vocational)</span>
              </div>

              <h3>Business & International Management</h3>
              <div className="course-tags">
                <span className="course-tag">📈 International Business (BBA)</span>
                <span className="course-tag">📦 Supply Chain Management</span>
                <span className="course-tag">💼 Tourism & Event Management</span>
              </div>
            </div>

            {/* CHAPTER 4: ADMISSIONS & VISAS */}
            <div id="admissions" className="scroll-section">
              <h2>Navigating Migri & The Residence Permit Process</h2>
              <p>You do not apply for a standard "student visa" for Finland; instead, you apply for a <strong>Student Residence Permit</strong> through the Finnish Immigration Service (Migri) via the EnterFinland portal.</p>
              
              <h3>The Step-by-Step Admission Process</h3>
              <div className="timeline">
                <div className="timeline-step">
                  <div className="step-num">1</div>
                  <div className="step-content"><strong>Apply via Studyinfo.fi:</strong> Submit your application during the joint application period or rolling admissions. Wait for the university to issue your official acceptance letter.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">2</div>
                  <div className="step-content"><strong>Pay Tuition Fees:</strong> Accept your study place and pay your first-year tuition fee. Do this quickly to secure any available Early Bird Scholarships.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">3</div>
                  <div className="step-content"><strong>EnterFinland Portal:</strong> Create an account on EnterFinland.fi. Fill out the Residence Permit application, upload your financial proofs (€9,600) and medical insurance, and pay the processing fee.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">4</div>
                  <div className="step-content"><strong>VFS Biometrics:</strong> Book an appointment at VFS Global in India. You must personally visit to prove your identity and submit your biometrics (fingerprints).</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">5</div>
                  <div className="step-content"><strong>Migri Decision & RP Card:</strong> Migri processes the application. Once approved, your physical Residence Permit (RP) card is delivered to VFS in India. You can then travel to Finland.</div>
                </div>
              </div>
            </div>
            ...
            <div id="documents" className="scroll-section">
              ...
              <p>Migri is highly efficient but strict. Your documents must be clear, honest, and perfectly aligned with their specific requirements.</p>
              
              <h3>Required Visa (Residence Permit) Documents</h3>
              <ul className="doc-list">
                <li>Valid Passport (All pages scanned)</li>
                <li>Official Acceptance Letter from the Finnish Educational Institution</li>
                <li>Receipt of Tuition Fee Payment</li>
                <li><strong>Proof of Funds:</strong> Bank statements showing at least €9,600 in your own name.</li>
                <li><strong>Comprehensive Health Insurance:</strong> Must cover medical expenses up to €120,000 (if studies are less than 2 years) or €40,000 (if studies are 2+ years).</li>
                <li>All Academic Transcripts & Degrees</li>
                <li>Valid IELTS/PTE Score (As required by the university)</li>
                <li>Clarification of origin of funds (e.g., parents' ITRs or Education Loan letter)</li>
              </ul>
            </div>

            {/* CHAPTER 6: CAREERS */}
            <div id="careers" className="scroll-section">
              <h2>Work Rights, PSW, and PR Pathways</h2>
              <p>Finland offers one of the most progressive and supportive immigration frameworks in Europe to help students transition into long-term residents.</p>
              
              <h3>Part-Time Work During Studies</h3>
              <p>International students in Finland are legally allowed to work up to <strong>30 hours per week</strong> during the academic semester. During holiday periods, there are no restrictions on working hours. The minimum wage is highly competitive, easily allowing students to cover rent and groceries.</p>

              <div className="content-highlight">
                <p><strong>The "A" Permit & Permanent Residency (PR):</strong> Previously, students received a temporary "B" permit. Now, students receive a continuous <strong>"A" permit</strong>. Because an A permit indicates continuous residence, your years spent studying directly count towards the 4-year requirement needed to apply for Finnish Permanent Residency.</p>
              </div>

              <h3>2-Year Job Seeker Visa</h3>
              <p>After graduating, if you haven't already secured a job, you can apply for a Job Seeker Permit. This grants you up to <strong>2 full years</strong> to stay in Finland, look for work, or start a business. Once employed, you seamlessly switch to a work-based residence permit.</p>
            </div>
            ...
            <div id="faqs" className="scroll-section">
              ...
              <div className="faq-card">
                <h4>Are Vocational (VET) courses a good option for Indian students?</h4>
                <p>Yes, absolutely. If you want a fast, highly practical route into the European job market, VET courses (like Practical Nursing or Culinary Arts) are fantastic. They are cheaper, shorter, and target sectors in Finland that are experiencing massive labor shortages.</p>
              </div>
              
              <div className="faq-card">
                <h4>Do I need to learn the Finnish language?</h4>
                <p>While your university degree will be entirely in English and most Finns speak perfect English, learning basic Finnish is highly recommended. It significantly increases your chances of securing part-time jobs and makes long-term integration and PR applications much easier.</p>
              </div>

              <div className="faq-card">
                <h4>Can my spouse work full-time in Finland?</h4>
                <p>Yes! Finland is extremely favorable for married students. If you apply for a Residence Permit, your spouse can apply for a dependent permit simultaneously. Upon approval, your spouse is granted full, unrestricted working rights in Finland from day one.</p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#4B5563", margin: 0, maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
              Every country offers unique opportunities. Compare Finland with other top global study destinations to find your perfect fit.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, flex: "1 1 400px" }}>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 900, color: "white", letterSpacing: "-0.5px", margin: "0 0 16px" }}>
                Ready to Apply to Finland?
              </h2>
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.6, maxWidth: "480px" }}>
                Connect with our certified experts to secure your university or vocational admission, structure your financial documents for Migri, and successfully lodge your Residence Permit application.
              </p>
            </div>
