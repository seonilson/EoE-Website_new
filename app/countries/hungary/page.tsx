...
// ── Data: Quick Facts ─────────────────────────────────────────
const quickFacts = [
  { icon: "🏛️", label: "Capital", value: "Budapest" },
  { icon: "💵", label: "Currency", value: "HUF (Hungarian Forint)" },
  { icon: "🗣️", label: "Language", value: "Hungarian & English" },
  { icon: "☀️", label: "Weather", value: "Continental (Warm Summers, Cold Winters)" },
  { icon: "🎓", label: "Top Intakes", value: "September (Main) & February" },
];

// ── Data: Section Navigation ──────────────────────────────────
const tabsData = [
  { id: "overview", icon: "🌍", label: "Why Hungary?" },
  { id: "institutions", icon: "🏛️", label: "Top Universities" },
  { id: "courses", icon: "🎯", label: "MBBS & Aviation" },
  { id: "admissions", icon: "📝", label: "Visa Process" },
  { id: "documents", icon: "📂", label: "Documents" },
  { id: "careers", icon: "💼", label: "TRC & Work Rights" },
  { id: "faqs", icon: "❓", label: "FAQs" }
];

// ── Data: Other Destinations (Swipe Track) ────────────────────
const otherDestinations = [
  { id: "poland", name: "Poland", flag: "/images/flags/pl.png" },
  { id: "germany", name: "Germany", flag: "/images/flags/de.png" },
  { id: "latvia", name: "Latvia", flag: "/images/flags/lv.png" },
  { id: "lithuania", name: "Lithuania", flag: "/images/flags/lt.png" }
];
...
//  HUNGARY MASTER PAGE
// ═══════════════════════════════════════════════════════════════
export default function CountryHungaryPage() {
  useEffect(() => { document.title = "Study in Hungary 2026 — Student Visa, Stipendium & Universities | Edification Overseas"; }, []);
        ...
        <div ref={heroRef.ref} className="hero-inner" style={{ maxWidth: "1280px", width: "100%", margin: "0 auto", padding: "20px 24px 60px", position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div className="hero-left-col" style={{ flex: "1 1 550px" }}>
            ...
            <p style={{
              ...
              Discover world-class academics and vibrant student life in Budapest. A <strong>Hungary Student Visa</strong> grants Indian students full <strong>Schengen Zone</strong> access, incredibly affordable tuition, prestigious <strong>NMC-approved MBBS programs</strong>, and the unique opportunity to master high-end <strong>Aviation and Piloting</strong> degrees.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px", aspectRatio: "1/1", animation: "float1 6s infinite ease-in-out" }}>
              <Image 
                src="/images/monuments/hungary.png" 
                alt="Hungary Parliament Monument Budapest" 
                fill 
            ...
            <div style={{ position: "absolute", top: "10%", right: "10%", width: "90px", height: "90px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", zIndex: 9, animation: "float2 7s infinite reverse", overflow: "hidden", boxShadow: "0 16px 40px rgba(0,0,0,0.3)" }}>
               <Image src="/images/flags/hu.png" alt="Hungary Flag" fill style={{ objectFit: "cover" }} />
            </div>
            ...
            <div style={{ position: "absolute", bottom: "60px", right: "0px", zIndex: 3, animation: "float1 7s infinite reverse" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontSize: "10px", color: "#07CBEB", textTransform: "uppercase", fontWeight: 800 }}>Elite Programs</span>
                  <span style={{ fontSize: "14px", fontWeight: 800, color: "#ffffff" }}>Aviation & Medical</span>
                </div>
              </div>
            </div>
        ...
        <div className="content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#022C45", margin: 0, letterSpacing: "-0.5px" }}>
              Your Complete Guide to Education in Hungary
            </h2>
          </div>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div id="overview" className="scroll-section">
              <h2>Why Study in Hungary? Central Europe’s Hidden Gem</h2>
              <p>Hungary is rapidly becoming a highly favored destination for Indian students. It perfectly balances a rich, historic academic tradition with a vibrant, modern student lifestyle, especially in the capital city of Budapest. A <strong>Hungarian Student Visa (Type D)</strong> provides a highly affordable gateway into the European Union and the broader Schengen market.</p>
              
              <h3>Key Advantages of Education in Hungary</h3>
              <div className="info-grid">
                <div className="info-card">
                  <h4>💶 Stipendium Hungaricum</h4>
                  <p>A massive draw for international students, this prestigious government scholarship offers fully funded tuition, a monthly stipend, and free accommodation for top applicants.</p>
                </div>
                <div className="info-card">
                  <h4>🌍 Full Schengen Access</h4>
                  <p>As a member of the EU and Schengen zone, your Hungarian TRC allows you to travel freely to 27 European countries for tourism and professional networking.</p>
                </div>
                <div className="info-card">
                  <h4>🩺 Premier Medical Education</h4>
                  <p>Hungary is renowned for its elite medical universities, offering English-taught MBBS and Dentistry programs fully recognized by the NMC and WHO.</p>
                </div>
                <div className="info-card">
                  <h4>💼 Post-Study Work Opportunities</h4>
                  <p>Graduates from Hungarian universities can apply for a highly beneficial 9-month "Study-to-Work" transition visa to secure local employment.</p>
                </div>
              </div>
            </div>
            ...
            <div id="institutions" className="scroll-section">
              ...
              <p>Hungary boasts a rigorous, state-funded higher education system. Indian students primarily target major public universities for Medicine, Engineering, and specialized Aviation courses.</p>
              
              <h3>Elite Medical Universities (NMC Approved)</h3>
              <p>These historic institutions are globally ranked and heavily favored by Indian medical aspirants:</p>
              <div className="course-tags">
                <span className="course-tag-blue">🏛️ Semmelweis University</span>
                <span className="course-tag-blue">🏛️ University of Debrecen</span>
                <span className="course-tag-blue">🏛️ University of Szeged</span>
                <span className="course-tag-blue">🏛️ University of Pécs</span>
              </div>

              <h3>Top Engineering, Aviation & General Universities</h3>
              <p>Highly reputed for deep technical learning and specialized programs like Professional Piloting:</p>
              <div className="course-tags">
                <span className="course-tag">🏫 Budapest University of Technology and Economics (BME)</span>
                <span className="course-tag">🏫 Eötvös Loránd University (ELTE)</span>
                <span className="course-tag">🏫 Corvinus University of Budapest</span>
                <span className="course-tag">🏫 University of Nyíregyháza</span>
              </div>
              
              <h3>Estimated Financial Requirements</h3>
              <p>Compared to Western Europe, Hungary is famously budget-friendly, making the financial documentation for visas much more manageable.</p>
              
              <div className="stat-grid">
                <div className="stat-card">
                  <div className="stat-value">€ 3k - € 6k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Bachelors / Business)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">€ 4k - € 8k</div>
                ...
                <div className="stat-card" style={{ background: "#fff5ee", borderColor: "rgba(241,97,1,0.3)" }}>
                  <div className="stat-value" style={{ color: "#F16101" }}>€ 400 - € 600</div>
            ...
            <div id="courses" className="scroll-section">
              <h2>High-Demand Courses in Hungary</h2>
              <p>Hungary is globally recognized for producing highly skilled graduates in Medical sciences and advanced Engineering disciplines, including highly unique Aviation programs.</p>
              
              <h3>Medicine & Healthcare (MBBS)</h3>
              <p>Hungarian medical degrees are prestigious, completely taught in English, and offer world-class European clinical rotations.</p>
              <div className="course-tags">
                <span className="course-tag">🩺 General Medicine (MD/MBBS)</span>
                <span className="course-tag">🦷 Dentistry</span>
                <span className="course-tag">💊 Pharmacy & Veterinary Medicine</span>
              </div>

              <h3>Aviation & Professional Piloting</h3>
              <div className="content-highlight" style={{ marginBottom: "20px" }}>
                <p><strong>Professional Pilot BSc Program:</strong> Hungary is one of the few European countries offering highly structured, English-taught Bachelor's degrees in Aviation. Institutions like the <strong>University of Nyíregyháza</strong> provide intensive Professional Pilot programs that combine academic theory with rigorous European flight training.</p>
              </div>
              ...
              <div className="course-tags">
                ...
                <span className="course-tag">📈 International Business & Economics</span>
              </div>
            </div>

            {/* CHAPTER 4: ADMISSIONS & VISAS */}
            <div id="admissions" className="scroll-section">
              <h2>Navigating the Hungarian Visa Process</h2>
              <p>Indian students must apply for a <strong>National D-Type Visa</strong> for long-term studies. The process is straightforward but requires precise financial documentation and an embassy appointment.</p>
              
              <h3>The Step-by-Step Visa Process</h3>
              <div className="timeline">
                <div className="timeline-step">
                  <div className="step-num">1</div>
                  <div className="step-content"><strong>University Admission:</strong> Submit your academic transcripts, passport, and English proficiency proof (or MOI) to secure your Conditional Offer Letter.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">2</div>
                  <div className="step-content"><strong>Pay Tuition Fees:</strong> Pay your first-year (or first semester) tuition fee directly to the university to receive your Final Acceptance Letter and Visa Support Certificate.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">3</div>
                  <div className="step-content"><strong>Prepare Financials & Insurance:</strong> Arrange your living expense proofs (bank statements or sponsor letters showing approx €5,000 - €7,000) and purchase mandatory Schengen travel insurance.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">4</div>
                  <div className="step-content"><strong>Embassy Submission & Interview:</strong> Book a D-Visa appointment via VFS Global in India. Submit your complete physical file and attend a short, mandatory visa interview at the Hungarian Embassy.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">5</div>
                  <div className="step-content"><strong>Arrival & TRC:</strong> Travel to Hungary. Within 30 days of your arrival, you must register your address and collect your Temporary Residence Card (TRC) from the local immigration office.</div>
                </div>
              </div>
            </div>
            ...
            <div id="documents" className="scroll-section">
              ...
              <p>The Hungarian Embassy strictly reviews documents for authenticity. Your primary educational documents must be legalized in India.</p>
              ...
              <ul className="doc-list">
                ...
                <li>Official Acceptance Letter from a Hungarian University</li>
                <li>Proof of Tuition Fee Payment</li>
                <li>Valid IELTS/PTE Score OR Medium of Instruction (MOI) Letter</li>
                <li>Proof of Financial Means (Bank statements covering living costs and return flight)</li>
                <li>Proof of Accommodation in Hungary (Hostel confirmation or Rental agreement)</li>
                <li>Comprehensive Travel & Health Insurance (Covering at least €30,000)</li>
              </ul>
            </div>
            ...
            <div id="careers" className="scroll-section">
              ...
              <p>Hungary offers an incredibly welcoming environment for international graduates, providing clear pathways to integrate into the European labor market.</p>
              
              <h3>Part-Time Work During Studies</h3>
              <p>International students holding a valid Hungarian TRC are legally permitted to work part-time for up to <strong>24 hours per week</strong> during the academic semester, and full-time (40 hours) during official university holidays, helping you manage your living expenses comfortably.</p>

              <div className="content-highlight">
                <p><strong>Study-to-Work Visa (Job Seeker):</strong> Upon successful graduation from a full-time program at a Hungarian university, you can apply for a highly beneficial <strong>9-month "Study-to-Work" transition TRC</strong>. This allows you to stay in Hungary specifically to search for employment or start a business. Once you secure a job contract, you transition to a standard European Work Permit.</p>
              </div>
            </div>
            ...
            <div id="faqs" className="scroll-section">
              ...
              <div className="faq-card">
                <h4>What is the Stipendium Hungaricum Scholarship?</h4>
                <p>It is one of Europe's most generous government scholarship programs. It covers full tuition fees, provides a monthly living stipend, and includes medical insurance and a housing allowance. It is highly competitive and based on bilateral agreements between Hungary and India.</p>
              </div>
              
              <div className="faq-card">
                <h4>Can I study in Hungary without IELTS?</h4>
                <p>Yes. Many Hungarian universities will accept Indian students without IELTS if they provide a Medium of Instruction (MOI) letter proving their previous education was conducted entirely in English. The university will often conduct a short Skype interview to verify your fluency.</p>
              </div>

              <div className="faq-card">
                <h4>Is the MBBS degree from Hungary valid in India?</h4>
                <p>Yes. Medical degrees from recognized Hungarian state universities (like Semmelweis or Debrecen) are fully recognized by the National Medical Commission (NMC) of India and the WHO. Indian students simply need to pass the FMGE/NEXT exam upon returning to practice in India.</p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#4B5563", margin: 0, maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
              Every country offers unique opportunities. Compare Hungary with other top global study destinations to find your perfect fit.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, flex: "1 1 400px" }}>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 900, color: "white", letterSpacing: "-0.5px", margin: "0 0 16px" }}>
                Ready to Apply to Hungary?
              </h2>
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.6, maxWidth: "480px" }}>
                Connect with our certified experts to secure your university admission, accurately organize your Apostilled and financial documents, and successfully lodge your Hungarian Student Visa.
              </p>
            </div>
