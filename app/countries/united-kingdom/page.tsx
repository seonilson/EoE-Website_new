...
// ── Data: Quick Facts ─────────────────────────────────────────
const quickFacts = [
  { icon: "🏛️", label: "Capital", value: "London" },
  { icon: "💷", label: "Currency", value: "GBP (£ / Pound)" },
...
const tabsData = [
  { id: "overview", icon: "👑", label: "Why UK?" },
  { id: "institutions", icon: "🏛️", label: "Top Universities" },
  { id: "courses", icon: "🎯", label: "Top Courses" },
  { id: "admissions", icon: "📝", label: "CAS & Visa Process" },
  { id: "documents", icon: "📂", label: "Documents" },
  { id: "careers", icon: "💼", label: "18-Month PSW" },
...
const otherDestinations = [
  ...
  { id: "georgia", name: "Georgia", flag: "/images/flags/ge.png" },
        ...
        <div ref={heroRef.ref} className="hero-inner" style={{ maxWidth: "1280px", width: "100%", margin: "0 auto", padding: "20px 24px 60px", position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div className="hero-left-col" style={{ flex: "1 1 550px" }}>
            ...
            <p style={{
              ...
              The ultimate choice for Indian students. A <strong>UK Student Visa</strong> offers world-renowned education, intensive <strong>1-Year Master's Degrees</strong>, flexible IELTS waivers, and the updated <strong>18-Month Graduate Route Visa</strong> to launch your global career.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px", aspectRatio: "1/1", animation: "float1 6s infinite ease-in-out" }}>
              <Image 
                src="/images/monuments/uk.png" 
                alt="UK Big Ben Monument" 
                fill 
            ...
            <div style={{ position: "absolute", top: "10%", right: "10%", width: "90px", height: "90px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", zIndex: 9, animation: "float2 7s infinite reverse", overflow: "hidden", boxShadow: "0 16px 40px rgba(0,0,0,0.3)" }}>
               <Image src="/images/flags/gb.png" alt="UK Flag" fill style={{ objectFit: "cover" }} />
            </div>
            ...
            <div style={{ position: "absolute", bottom: "60px", right: "0px", zIndex: 3, animation: "float1 7s infinite reverse" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                <span style={{ fontSize: "20px" }}>🎓</span>
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontSize: "10px", color: "#07CBEB", textTransform: "uppercase", fontWeight: 800 }}>Fast Track</span>
                  <span style={{ fontSize: "14px", fontWeight: 800, color: "#ffffff" }}>1-Year Masters</span>
                </div>
              </div>
            </div>
        ...
        <div className="content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#022C45", margin: 0, letterSpacing: "-0.5px" }}>
              Your Complete Guide to Education in the UK
            </h2>
          </div>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div id="overview" className="scroll-section">
              <h2>Why Study in the UK? The Leading Choice for Indians</h2>
              <p>The UK has a deep historical, educational, and cultural connection with India. Renowned for academic excellence, a <strong>UK Student Visa</strong> offers a fast-paced, high-return investment for your career, featuring intense, globally respected degrees and highly structured post-study opportunities.</p>
              
              <h3>Key Advantages of Education in the UK</h3>
              <div className="info-grid">
                <div className="info-card">
                  <h4>🎓 1-Year Master’s Degree</h4>
                  <p>Unlike the US or Canada which require 2 years, the UK offers intensive 1-year Master’s programs, saving you a full year of tuition and living expenses.</p>
                </div>
                <div className="info-card">
                  <h4>💼 Updated Post Study Work Visa</h4>
                  <p>Under the latest Graduate Route rules, eligible international students can remain in the UK for up to 18 months (or 3 years for PhDs) to gain crucial global work experience.</p>
                </div>
                <div className="info-card">
                  <h4>🚫 Flexible English Rules (MOI)</h4>
                  <p>Many top UK universities will waive the IELTS requirement if you scored over 70% in English in your 12th standard (CBSE/State Boards).</p>
                </div>
                <div className="info-card">
                  <h4>🏛️ The Russell Group Prestige</h4>
                  <p>Home to the Russell Group (the UK equivalent of the Ivy League), offering unparalleled research facilities and global employability.</p>
                </div>
              </div>
            </div>
            ...
            <div id="institutions" className="scroll-section">
              <h2>Top Universities, Russell Group & Cost of Living</h2>
              <p>The UK features a wide spectrum of universities. Whether you are aiming for elite research institutions or practical, highly-accessible modern universities, the UK has an option for every budget and profile.</p>
              
              <h3>Elite Russell Group Universities</h3>
              <p>Highly prestigious, research-intensive universities favored by top academic achievers:</p>
              <div className="course-tags">
                <span className="course-tag-blue">🏛️ University of Birmingham</span>
                <span className="course-tag-blue">🏛️ University of Warwick</span>
                <span className="course-tag-blue">🏛️ Queen Mary University of London</span>
                <span className="course-tag-blue">🏛️ University of Leeds</span>
              </div>

              <h3>Highly Popular & Accessible Universities</h3>
              <p>These universities are heavily promoted in the Indian market due to their excellent placement records, affordable fees, and highly flexible admission criteria:</p>
              <div className="course-tags">
                <span className="course-tag">🏫 Leeds Beckett University</span>
                <span className="course-tag">🏫 Anglia Ruskin University</span>
                <span className="course-tag">🏫 Cardiff Metropolitan University</span>
                <span className="course-tag">🏫 University of Roehampton</span>
                <span className="course-tag">🏫 University of Strathclyde</span>
                <span className="course-tag">🏫 Liverpool John Moores University</span>
                <span className="course-tag">🏫 De Montfort University</span>
                <span className="course-tag">🏫 Coventry University</span>
                <span className="course-tag">🏫 Aston University</span>
                <span className="course-tag">🏫 University of East London (UEL)</span>
                <span className="course-tag">🏫 Teesside University</span>
                <span className="course-tag">🏫 Sheffield Hallam University</span>
                <span className="course-tag">🏫 University of Hertfordshire</span>
                <span className="course-tag">🏫 BPP University</span>
                <span className="course-tag">🏫 Ulster University</span>
              </div>
              
              <h3>Estimated Financial Requirements</h3>
              <p>The UK uses a strict Point-Based Visa system where your financial documentation must be absolutely precise.</p>
              
              <div className="stat-grid">
                <div className="stat-card">
                  <div className="stat-value">£14k - £18k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Bachelors Degrees)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">£15k - £25k</div>
                  <div className="stat-label">Avg. Tuition<br/>(1-Year Masters)</div>
                </div>
                <div className="stat-card" style={{ background: "#fff5ee", borderColor: "rgba(241,97,1,0.3)" }}>
                  <div className="stat-value" style={{ color: "#F16101" }}>£1,334 / mo</div>
                  <div className="stat-label">Living Funds Required<br/>(Inside London)</div>
                </div>
                <div className="stat-card" style={{ background: "#fff5ee", borderColor: "rgba(241,97,1,0.3)" }}>
                  <div className="stat-value" style={{ color: "#F16101" }}>£1,023 / mo</div>
                  <div className="stat-label">Living Funds Required<br/>(Outside London)</div>
                </div>
              </div>

              <div className="content-highlight">
                <p><strong>The Strict 28-Day Fund Rule:</strong> To secure your UK Student Visa, the required living funds plus any unpaid tuition fees must be held in your bank account for exactly <strong>28 consecutive days</strong> before you submit your visa application. This is a non-negotiable immigration rule.</p>
              </div>
            </div>

            {/* CHAPTER 3: COURSES */}
            <div id="courses" className="scroll-section">
              <h2>High-Demand Courses in the UK</h2>
              <p>The UK job market has specific shortage occupations. Aligning your studies with these fields maximizes your chances of securing long-term sponsorship after your Graduate Route visa expires.</p>
              
              <h3>Business, Management & Analytics</h3>
              <p>The UK is a global financial powerhouse. Master's in Management (MIM) and MBAs are incredibly popular.</p>
              <div className="course-tags">
                <span className="course-tag">📈 Master of Business Administration (MBA)</span>
                <span className="course-tag">📊 Business Analytics</span>
                <span className="course-tag">💰 Finance & Investment</span>
              </div>

              <h3>Healthcare & Nursing</h3>
              <p>The UK National Health Service (NHS) is actively recruiting international talent. These degrees almost guarantee immediate employment.</p>
              <div className="course-tags">
                <span className="course-tag">🏥 BSc/MSc Nursing</span>
                <span className="course-tag">💊 Public Health & Pharmacy</span>
                <span className="course-tag">🧬 Biomedical Sciences</span>
              </div>

              <h3>Information Technology & Engineering</h3>
              <div className="course-tags">
                <span className="course-tag">💻 Artificial Intelligence & Data Science</span>
                <span className="course-tag">⚙️ Advanced Mechanical Engineering</span>
            ...
            <div id="admissions" className="scroll-section">
              <h2>Navigating the CAS & UK Visa Process</h2>
              <p>The UK Student Route is a points-based system. The absolute most important document in this process is your <strong>CAS Letter (Confirmation of Acceptance for Studies)</strong> issued by your university.</p>
              
              <h3>The Step-by-Step UK Admission Process</h3>
              <div className="timeline">
                <div className="timeline-step">
                  <div className="step-num">1</div>
                  <div className="step-content"><strong>Conditional Offer:</strong> Submit your academics, SOP, and LORs via the UCAS portal (for UG) or directly to the university (for PG) to receive a conditional offer.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">2</div>
                  <div className="step-content"><strong>Clear Conditions & Pre-CAS Interview:</strong> Pass the university's internal credibility interview, show proof of 28-day funds, and pay the initial tuition deposit.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">3</div>
                  <div className="step-content"><strong>CAS Issuance:</strong> Once the university is satisfied, they issue the official <strong>CAS Letter</strong>. You cannot apply for a visa without this specific electronic document.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">4</div>
                  <div className="step-content"><strong>Visa Application & IHS Fee:</strong> Pay the visa fee and the Immigration Health Surcharge (IHS) online, then submit your biometric file at VFS Global in India.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">5</div>
                  <div className="step-content"><strong>Arrival & BRP/eVisa Collection:</strong> Travel to the UK with your entry vignette and set up your digital UKVI eVisa or collect your Biometric Residence Permit (BRP).</div>
                </div>
              </div>
            </div>
            ...
            <div id="documents" className="scroll-section">
              ...
              <p>The UK visa process is highly rigid. A single missing document or incorrect fund calculation can lead to immediate refusal.</p>
              ...
              <ul className="doc-list">
                ...
                <li>Valid IELTS/PTE Score OR 12th English Marks for MOI Waiver</li>
                <li>Statement of Purpose (SOP) - A highly critical document for UK universities</li>
                <li>Letters of Recommendation (LOR) from professors or employers</li>
                <li><strong>Official CAS Letter</strong> from your UK University</li>
                <li>Bank Statements showing tuition + living funds held for 28 consecutive days</li>
                <li><strong>Tuberculosis (TB) Test Certificate</strong> from a UKVI-approved clinic in India</li>
              </ul>
            </div>
            ...
            <div id="careers" className="scroll-section">
              ...
              <p>The UK offers highly structured post-study work rights designed to help international students transition smoothly into the global workforce.</p>
              
              <h3>Part-Time Work During Studies</h3>
              <p>International students studying a degree-level course in the UK are legally allowed to work up to <strong>20 hours per week</strong> during the academic term, and full-time during official university holidays. This helps cover day-to-day living expenses.</p>

              <div className="content-highlight">
                <p><strong>The Latest 18-Month Graduate Route Visa:</strong> Following recent updates to UK immigration rules, eligible international graduates can now stay in the UK for up to <strong>18 months</strong> (reduced from the previous 2-year duration) to work, or look for work, at any skill level. Students graduating with a PhD are still granted a 3-year extension. To settle permanently, students must eventually secure sponsorship from an employer under the Skilled Worker Visa.</p>
              </div>
            </div>
            ...
            <div id="faqs" className="scroll-section">
              ...
              <div className="faq-card">
                <h4>Is a 1-Year Master's degree from the UK globally recognized?</h4>
                <p>Absolutely. The UK's 1-Year Master's degrees are highly intensive and are fully recognized by global employers and credential evaluators worldwide, including in India, the US, and Canada.</p>
              </div>
              
              <div className="faq-card">
                <h4>Can I really study in the UK without taking IELTS?</h4>
                <p>Yes. Many universities (such as Aston, UEL, and Coventry) will waive the IELTS requirement if you have scored 70% or higher in English in your 12th standard (CBSE, ICSE, or State Boards), provided you pass their internal video interview.</p>
              </div>

              <div className="faq-card">
                <h4>Can I bring my spouse or dependents with me?</h4>
                <p>As per the latest UKVI rules, only students enrolled in postgraduate research programs (like a PhD) are permitted to bring dependents. Students enrolled in undergraduate or standard taught Master's programs are no longer allowed to bring family members on their student visa.</p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#4B5563", margin: 0, maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
              Every country offers unique opportunities. Compare the UK with other top global study destinations to find your perfect fit.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, flex: "1 1 400px" }}>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 900, color: "white", letterSpacing: "-0.5px", margin: "0 0 16px" }}>
                Ready to Apply to the UK?
              </h2>
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.6, maxWidth: "480px" }}>
                Connect with our certified experts to secure your admission letter, obtain your official CAS, perfectly arrange your 28-day funds, and confidently lodge your UK Student Visa.
              </p>
            </div>
