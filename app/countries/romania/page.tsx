...
// ── Data: Quick Facts ─────────────────────────────────────────
const quickFacts = [
  { icon: "🏛️", label: "Capital", value: "Bucharest" },
  { icon: "💵", label: "Currency", value: "RON (Romanian Leu)" },
  { icon: "🗣️", label: "Language", value: "Romanian & English" },
  { icon: "❄️", label: "Weather", value: "Continental (Warm Summers, Cold Winters)" },
  { icon: "🎓", label: "Top Intakes", value: "October (Main) & February" },
];

// ── Data: Section Navigation ──────────────────────────────────
const tabsData = [
  { id: "overview", icon: "🌍", label: "Why Romania?" },
  { id: "institutions", icon: "🏛️", label: "Top Universities" },
  { id: "courses", icon: "🎯", label: "MBBS & Tech Courses" },
...
const otherDestinations = [
  ...
  { id: "hungary", name: "Hungary", flag: "/images/flags/hu.png" },
...
//  ROMANIA MASTER PAGE
// ═══════════════════════════════════════════════════════════════
export default function CountryRomaniaPage() {
  useEffect(() => { document.title = "Study in Romania 2026 — Student Visa, EU Degree & Universities | Edification Overseas"; }, []);
        ...
        <div ref={heroRef.ref} className="hero-inner" style={{ maxWidth: "1280px", width: "100%", margin: "0 auto", padding: "20px 24px 60px", position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div className="hero-left-col" style={{ flex: "1 1 550px" }}>
            ...
            <p style={{
              ...
              Unlock world-class European academics with exceptionally low living costs. A <strong>Romania Student Visa</strong> grants Indian students access to highly esteemed <strong>NMC-approved MBBS programs</strong>, top-tier engineering degrees, and a seamless <strong>post-study work transition</strong> across the EU.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px", aspectRatio: "1/1", animation: "float1 6s infinite ease-in-out" }}>
              <Image 
                src="/images/monuments/romania.png" 
                alt="Romania Palace of Parliament Monument" 
                fill 
            ...
            <div style={{ position: "absolute", top: "10%", right: "10%", width: "90px", height: "90px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", zIndex: 9, animation: "float2 7s infinite reverse", overflow: "hidden", boxShadow: "0 16px 40px rgba(0,0,0,0.3)" }}>
               <Image src="/images/flags/ro.png" alt="Romania Flag" fill style={{ objectFit: "cover" }} />
            </div>
            ...
            <div style={{ position: "absolute", top: "40px", left: "0px", zIndex: 3, animation: "float2 5s infinite" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  <span style={{ fontSize: "14px", fontWeight: 800, color: "#ffffff" }}>EU Member State</span>
                </div>
              </div>
            </div>
        ...
        <div className="content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#022C45", margin: 0, letterSpacing: "-0.5px" }}>
              Your Complete Guide to Education in Romania
            </h2>
          </div>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div id="overview" className="scroll-section">
              <h2>Why Study in Romania? High Quality, Low Cost</h2>
              <p>Romania has steadily grown into a massive hub for international students, particularly from India. As a proud member of the European Union, a <strong>Romanian Student Visa</strong> guarantees access to world-class education, deeply historical universities, and some of the most budget-friendly living conditions on the entire continent.</p>
              
              <h3>Key Advantages of Education in Romania</h3>
              <div className="info-grid">
                <div className="info-card">
                  <h4>🩺 Premier Medical Hub</h4>
                  <p>Romania is famous for its top-tier medical universities, offering 6-year English-taught MBBS degrees that are fully recognized by the NMC and WHO.</p>
                </div>
                <div className="info-card">
                  <h4>💰 Extremely Low Living Costs</h4>
                  <p>Compared to Western Europe, rent, food, and public transportation in Romania are remarkably cheap, easing the financial burden on students.</p>
                </div>
                <div className="info-card">
                  <h4>🚫 No IELTS Hurdles</h4>
                  <p>Admissions are highly flexible. Many universities will issue acceptance letters without requiring strict IELTS or PTE scores, depending on your high school English grades.</p>
                </div>
                <div className="info-card">
                  <h4>💼 Post-Study Work Opportunities</h4>
                  <p>Graduates are granted a 9-month post-study visa to secure full-time employment, seamlessly transitioning into the European labor market.</p>
                </div>
              </div>
            </div>
            ...
            <div id="institutions" className="scroll-section">
              ...
              <p>Romania boasts an excellent network of state-funded public universities that provide rich academic traditions alongside modern European facilities.</p>
              
              <h3>Top Medical Universities (NMC Approved)</h3>
              <p>These institutions are highly competitive and are the absolute top choices for Indian students pursuing Medicine:</p>
              <div className="course-tags">
                <span className="course-tag-blue">🏛️ Carol Davila University of Medicine and Pharmacy</span>
                <span className="course-tag-blue">🏛️ Iuliu Hațieganu University of Medicine and Pharmacy (Cluj)</span>
                <span className="course-tag-blue">🏛️ Grigore T. Popa University of Medicine and Pharmacy</span>
                <span className="course-tag-blue">🏛️ Victor Babeș University of Medicine and Pharmacy</span>
              </div>

              <h3>Top Engineering & General Universities</h3>
              <p>Highly reputed for deep technical learning and IT programs:</p>
              <div className="course-tags">
                <span className="course-tag">🏫 Politehnica University of Bucharest</span>
                <span className="course-tag">🏫 Technical University of Cluj-Napoca</span>
                <span className="course-tag">🏫 Politehnica University of Timișoara</span>
                <span className="course-tag">🏫 University of Bucharest</span>
                <span className="course-tag">🏫 Babeș-Bolyai University</span>
              </div>
              
              <h3>Estimated Financial Requirements</h3>
              <p>While the currency is the Romanian Leu (RON), tuition fees for international students are generally quoted and paid in Euros (€).</p>
              
              <div className="stat-grid">
                <div className="stat-card">
                  <div className="stat-value">€ 3k - € 5k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Bachelors / Engineering)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">€ 6k - € 8.5k</div>
                ...
                <div className="stat-card" style={{ background: "#fff5ee", borderColor: "rgba(241,97,1,0.3)" }}>
                  <div className="stat-value" style={{ color: "#F16101" }}>€ 3k - € 5k</div>
            ...
            <div id="courses" className="scroll-section">
              <h2>High-Demand Courses in Romania</h2>
              <p>Choosing the right program is critical. Romania excels heavily in producing world-class medical professionals and high-end IT engineers.</p>
              
              <h3>Medicine & Healthcare (MBBS)</h3>
              <p>The 6-year MD (equivalent to MBBS) is the flagship program for Indian students, offering European clinical exposure and robust training.</p>
              <div className="course-tags">
                <span className="course-tag">🩺 General Medicine (MBBS)</span>
                <span className="course-tag">🦷 Dentistry (Stomatology)</span>
                <span className="course-tag">💊 Pharmacy</span>
              </div>

              <h3>Engineering & Information Technology</h3>
              <p>Romanian IT engineers are highly sought after across Europe. The technical universities in Bucharest and Cluj are massive recruitment hubs.</p>
              <div className="course-tags">
              ...
              <div className="course-tags">
                ...
                <span className="course-tag">📊 International Economics</span>
            ...
            <div id="admissions" className="scroll-section">
              <h2>Navigating the MEF & Romanian Visa Process</h2>
              <p>The admission process involves a strict validation by the Romanian government. You must first secure an official Letter of Acceptance from the Ministry of Education before applying for your visa.</p>
              
              <h3>The Step-by-Step Visa Process</h3>
              <div className="timeline">
                <div className="timeline-step">
                  <div className="step-num">1</div>
                  <div className="step-content"><strong>University Application:</strong> Submit your Apostilled academic transcripts, passport, and NEET scorecard (for medical students) directly to the university.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">2</div>
                  <div className="step-content"><strong>Ministry Approval (MEF):</strong> The university sends your file to the Romanian Ministry of Education. If approved, the Ministry issues the official <strong>Letter of Acceptance</strong>.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">3</div>
                  <div className="step-content"><strong>Pay Tuition Fees:</strong> Once the Acceptance Letter is issued, you must transfer your first year's tuition fee directly to the university’s bank account.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">4</div>
                  <div className="step-content"><strong>Embassy Submission:</strong> Apply for the Long-Stay (Type D) Student Visa via the eVisa portal and then submit your physical file to the Romanian Embassy/Consulate in India.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">5</div>
                  <div className="step-content"><strong>Arrival & TRC Registration:</strong> Travel to Romania. Within your first 30 to 60 days, you must register with the General Inspectorate for Immigration to receive your Temporary Residence Card (TRC).</div>
                </div>
              </div>
            </div>
            ...
            <div id="documents" className="scroll-section">
              ...
              <p>Romanian authorities are highly strict regarding document legalization. Your primary educational and legal documents must be Apostilled in India prior to application.</p>
              
              <h3>Required Admission & Visa Documents</h3>
              <ul className="doc-list">
                <li>Valid Passport (Valid for at least 1-2 years)</li>
                <li>All Academic Transcripts & Degrees (<strong>Apostilled by MEA</strong>)</li>
                <li><strong>NEET Scorecard</strong> (Mandatory for Indian students applying for MBBS)</li>
                <li><strong>Police Clearance Certificate (PCC)</strong> (Apostilled)</li>
                <li>Official Letter of Acceptance from the Ministry of Education</li>
                <li>Bank Statement showing required living funds (approx €3,000 - €5,000)</li>
                <li>Official Medical Certificate (Showing you do not suffer from contagious diseases)</li>
                <li>Comprehensive Travel & Health Insurance</li>
              </ul>
            </div>
            ...
            <div id="careers" className="scroll-section">
              ...
              <p>Romania provides a structured framework for international students to transition from their studies into the European workforce.</p>
              
              <h3>Part-Time Work During Studies</h3>
              <p>International students holding a valid Romanian TRC are legally permitted to work part-time for up to <strong>20 hours per week</strong> without needing a separate work permit. This allows students to comfortably manage their low living expenses.</p>

              <div className="content-highlight">
                <p><strong>Post-Study Job Seeker Visa:</strong> Upon successfully graduating from a Romanian university, international students are eligible to apply for a <strong>9-month extension</strong> on their residence permit specifically to seek employment. Once you secure a full-time job contract, you can easily transition to a standard European Work Permit.</p>
              </div>

              <h3>Post-Study Medical Pathways</h3>
              <p>Indian students who complete their MBBS (MD) in Romania must pass the <strong>FMGE / NEXT exam</strong> if they wish to practice in India. Alternatively, because the degree is recognized across the EU, many graduates pursue their medical residencies in countries like Germany, France, or the UK.</p>
            </div>
            ...
            <div id="faqs" className="scroll-section">
              ...
              <div className="faq-card">
                <h4>Is NEET mandatory to study MBBS in Romania?</h4>
                <p>Yes. If you are an Indian citizen intending to return to India to practice medicine after graduation, the National Medical Commission (NMC) strictly requires you to have qualified the NEET-UG exam before taking admission abroad.</p>
              </div>
              
              <div className="faq-card">
                <h4>Can I study in Romania without an IELTS score?</h4>
                <p>Yes. Many Romanian universities will accept Indian students without an IELTS or PTE score if they can provide a Medium of Instruction (MOI) letter from their high school proving that their previous education was conducted entirely in English.</p>
              </div>

              <div className="faq-card">
                <h4>What is the MEF Letter of Acceptance?</h4>
                <p>Unlike some countries where the university issues the final offer, in Romania, the university recommends you, but the actual, legal Letter of Acceptance is issued directly by the Romanian Ministry of Education. You cannot apply for a visa without this specific document.</p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#4B5563", margin: 0, maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
              Every country offers unique opportunities. Compare Romania with other top global study destinations to find your perfect fit.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, flex: "1 1 400px" }}>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 900, color: "white", letterSpacing: "-0.5px", margin: "0 0 16px" }}>
                Ready to Apply to Romania?
              </h2>
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.6, maxWidth: "480px" }}>
                Connect with our certified experts to secure your university admission, obtain your Ministry Acceptance Letter, completely structure your Apostilled documents, and successfully lodge your Romanian Student Visa.
              </p>
            </div>
