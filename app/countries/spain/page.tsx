...
// ── Data: Quick Facts ─────────────────────────────────────────
const quickFacts = [
  { icon: "🏛️", label: "Capital", value: "Madrid" },
  { icon: "💶", label: "Currency", value: "EUR (€ / Euro)" },
  { icon: "🗣️", label: "Language", value: "Spanish & English" },
  { icon: "☀️", label: "Weather", value: "Mediterranean (Sunny & Warm)" },
  { icon: "🎓", label: "Top Intakes", value: "September & February" },
];

// ── Data: Section Navigation ──────────────────────────────────
const tabsData = [
  { id: "overview", icon: "🌍", label: "Why Spain?" },
  { id: "institutions", icon: "🏛️", label: "Top Universities" },
  { id: "courses", icon: "🎯", label: "Business & Top Courses" },
    ...
    <h2 style={{ fontSize: "clamp(32px, 4vw, 44px)", fontWeight: 900, color, lineHeight: 1.1, letterSpacing: "-0.8px", margin: "0 0 16px" }}>
      ...
      <span style={{ position: "relative", display: "inline-block", background: "linear-gradient(100deg, #F16101 0%, #C9A24D 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
        ...
        <svg style={{ position: "absolute", bottom: "-6px", left: 0, width: "100%" }} height="5" viewBox="0 0 300 5" preserveAspectRatio="none">
          <defs><linearGradient id="ulineSpain" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stopColor="#F16101"/><stop offset="100%" stopColor="#C9A24D"/></linearGradient></defs>
          <path d="M0,3 Q75,0 150,3 Q225,7 300,3" stroke="url(#ulineSpain)" strokeWidth="3" fill="none" strokeLinecap="round"/>
        </svg>
      </span>
    </h2>
  );
...
//  SPAIN MASTER PAGE
// ═══════════════════════════════════════════════════════════════
export default function CountrySpainPage() {
  useEffect(() => { document.title = "Study in Spain 2026 — Student Visa, Universities & Costs | Edification Overseas"; }, []);
        ...
        <div ref={heroRef.ref} className="hero-inner" style={{ maxWidth: "1280px", width: "100%", margin: "0 auto", padding: "20px 24px 60px", position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div className="hero-left-col" style={{ flex: "1 1 550px" }}>
            <div style={{
              ...
              <span style={{ fontSize: "12px", fontWeight: 800, color: "rgba(255,255,255,0.9)", letterSpacing: "0.4px", textTransform: "uppercase" }}>
                The Hub of European Business & Culture
              </span>
            </div>
            ...
            <p style={{
              ...
              Experience vibrant student life, incredible Mediterranean weather, and globally elite education. A <strong>Spain Student Visa</strong> grants Indian students access to world-renowned <strong>Business Schools</strong>, highly affordable public universities, and an official <strong>1-Year Post-Study Job Search Visa</strong> to launch a European career.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px", aspectRatio: "1/1", animation: "float1 6s infinite ease-in-out" }}>
              <Image 
                src="/images/monuments/spain.png" 
                alt="Spain Sagrada Familia Monument" 
                fill 
            ...
            <div style={{ position: "absolute", top: "10%", right: "10%", width: "90px", height: "90px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", zIndex: 9, animation: "float2 7s infinite reverse", overflow: "hidden", boxShadow: "0 16px 40px rgba(0,0,0,0.3)" }}>
               <Image src="/images/flags/es.png" alt="Spain Flag" fill style={{ objectFit: "cover" }} />
            </div>
        ...
        <div className="content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#022C45", margin: 0, letterSpacing: "-0.5px" }}>
              Your Complete Guide to Education in Spain
            </h2>
          </div>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div id="overview" className="scroll-section">
              <h2>Why Study in Spain? Mediterranean Lifestyle Meets Global Business</h2>
              <p>Spain is an incredibly vibrant and dynamic destination for international students. Moving far beyond just a tourist hotspot, cities like Barcelona and Madrid have evolved into massive European tech and business hubs. For Indian students, a <strong>Spain Student Visa</strong> means gaining access to high-ranking English-taught programs, deeply engaging culture, and significantly lower living costs compared to Northern Europe.</p>
              
              <h3>Key Advantages of Education in Spain</h3>
              <div className="info-grid">
                <div className="info-card">
                  <h4>💼 1-Year Job Search Visa</h4>
                  <p>Graduates from Spanish universities are legally entitled to apply for a 12-month post-study visa, giving you ample time to secure a work contract in Europe.</p>
                </div>
                <div className="info-card">
                  <h4>📈 Elite Business Schools</h4>
                  <p>Spain dominates the European MBA and Master in Management (MIM) rankings, home to universally recognized institutions like IE, ESADE, and IESE.</p>
                </div>
                <div className="info-card">
                  <h4>☀️ Outstanding Quality of Life</h4>
                  <p>Spain offers an unbeatable combination of sunny Mediterranean weather, rich cultural heritage, safe cities, and highly affordable public transport and healthcare.</p>
                </div>
                <div className="info-card">
                  <h4>🗣️ Expanding English Programs</h4>
                  <p>While learning Spanish is a massive global asset, you do not need it to study. Hundreds of top Bachelors and Masters programs are now taught entirely in English.</p>
                </div>
              </div>
            </div>
            ...
            <div id="institutions" className="scroll-section">
              <h2>Top Universities, Business Schools & Cost of Living</h2>
              <p>The higher education landscape in Spain is wonderfully diverse. It features highly subsidized <strong>Public Universities</strong> with deep historical roots, and hyper-modern, intensely globally-focused <strong>Private Business Schools</strong>.</p>
              
              <h3>Elite Business Schools (Highly Popular Globally)</h3>
              <p>These institutions frequently top global rankings for MBAs and Management programs. They are highly corporate-focused and offer immense networking opportunities:</p>
              <div className="course-tags">
                <span className="course-tag-blue">🏛️ IE Business School (Madrid)</span>
                <span className="course-tag-blue">🏛️ ESADE Business School (Barcelona)</span>
                <span className="course-tag-blue">🏛️ IESE Business School (Barcelona/Madrid)</span>
                <span className="course-tag-blue">🏛️ EADA Business School</span>
              </div>

              <h3>Popular Private & International Universities (High ROI for Indians)</h3>
              <p>These universities are massive favorites in the Indian market due to their English-medium curriculums, practical approach, and highly flexible admissions:</p>
              <div className="course-tags">
                <span className="course-tag">🏫 UCAM (Universidad Católica San Antonio de Murcia)</span>
                <span className="course-tag">🏫 GBSB Global Business School</span>
                <span className="course-tag">🏫 EU Business School (Barcelona Campus)</span>
                <span className="course-tag">🏫 Geneva Business School (Barcelona Campus)</span>
                <span className="course-tag">🏫 Schiller International University (Madrid)</span>
              </div>

              <h3>Top Public Universities (General & Tech)</h3>
              <div className="course-tags">
                <span className="course-tag">🏫 University of Barcelona (UB)</span>
                <span className="course-tag">🏫 Complutense University of Madrid</span>
                <span className="course-tag">🏫 Polytechnic University of Catalonia (UPC)</span>
                <span className="course-tag">🏫 Charles III University of Madrid (UC3M)</span>
              </div>
              
              <h3>Estimated Financial Requirements</h3>
              <p>Spain requires students to prove their financial stability using the IPREM index (Indicador Público de Renta de Efectos Múltiples), which ensures you can cover your living expenses.</p>
              
              <div className="stat-grid">
                <div className="stat-card">
                  <div className="stat-value">€ 1.5k - € 4k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Public Universities)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">€ 8k - € 25k+</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Private/Business Schools)</div>
                </div>
                <div className="stat-card">
                ...
                <div className="stat-card" style={{ background: "#fff5ee", borderColor: "rgba(241,97,1,0.3)" }}>
                  <div className="stat-value" style={{ color: "#F16101" }}>€ 7,500 - € 8,500</div>
            ...
            <div id="courses" className="scroll-section">
              <h2>High-Demand Courses in Spain</h2>
              <p>Spain is globally unique in its program offerings. While traditional engineering and IT are strong, Spain dominates globally in specialized business, hospitality, and sports management.</p>
              
              <h3>Business & Management (MIM/MBA)</h3>
              <p>With cities like Barcelona becoming massive startup hubs, English-taught management degrees are the #1 choice for international students.</p>
              <div className="course-tags">
                <span className="course-tag">📈 Master in Management (MIM)</span>
                <span className="course-tag">💼 Global MBA</span>
                <span className="course-tag">📊 Digital Marketing & E-Commerce</span>
              </div>

              <h3>Sports Management & Hospitality</h3>
              <p>Spain is home to some of the world's biggest football clubs (Real Madrid, FC Barcelona) and a booming tourism industry. Universities like UCAM specialize heavily in these sectors.</p>
              <div className="course-tags">
                <span className="course-tag">⚽ Sports Management & Marketing</span>
                <span className="course-tag">🏨 Tourism & Hospitality Management</span>
                <span className="course-tag">✈️ Event Management</span>
              </div>

              <h3>Architecture & Technology</h3>
              <div className="course-tags">
                <span className="course-tag">🏛️ Architecture & Urban Design</span>
                <span className="course-tag">💻 Data Science & Business Analytics</span>
                <span className="course-tag">⚙️ Renewable Energy Engineering</span>
              </div>
            </div>

            {/* CHAPTER 4: ADMISSIONS & VISAS */}
            <div id="admissions" className="scroll-section">
              <h2>Navigating the Spain Visa Process</h2>
              <p>Indian students intending to study in Spain for more than 90 days must apply for a <strong>National Visa (Type D)</strong> for study purposes through BLS International or VFS Global.</p>
              
              <h3>The Step-by-Step Visa Process</h3>
              <div className="timeline">
                <div className="timeline-step">
                  <div className="step-num">1</div>
                  <div className="step-content"><strong>University Admission:</strong> Submit your application to your chosen university. For public universities, you may need your Indian degrees evaluated (Homologación). Private schools have a much simpler direct admission process.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">2</div>
                  <div className="step-content"><strong>Receive the Admission Letter:</strong> Pay your initial tuition deposit to receive the official, stamped Admission Letter, which is the foundational document for your visa.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">3</div>
                  <div className="step-content"><strong>Document Apostille & Translation:</strong> Spain is extremely strict regarding legal documents. Your Police Clearance Certificate (PCC) and Medical Certificate must be Apostilled by the MEA in India and often translated into Spanish by a sworn translator.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">4</div>
                  <div className="step-content"><strong>Visa Submission:</strong> Compile your financial proofs, insurance, and Apostilled documents. Book an appointment and submit your file at the BLS/VFS Spain Visa Application Center.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">5</div>
                  <div className="step-content"><strong>Arrival & TIE Card:</strong> Once your visa is approved, travel to Spain. Within 30 days of arrival, you must register at the local police station to obtain your TIE (Tarjeta de Identidad de Extranjero), your official residence card.</div>
                </div>
              </div>
            </div>
            ...
            <div id="documents" className="scroll-section">
              ...
              <p>The Spanish Consulate requires meticulous documentation. Any errors in the medical certificate format or missing Apostilles can lead to instant delays.</p>
              
              <h3>Required Admission & Visa Documents</h3>
              <ul className="doc-list">
                <li>Valid Passport (Valid for the entire duration of the course)</li>
                <li>Official Admission Letter from a recognized Spanish Institution</li>
                <li><strong>Medical Certificate:</strong> Must explicitly state you do not suffer from any diseases that could cause public health repercussions (Requires Apostille).</li>
                <li><strong>Police Clearance Certificate (PCC):</strong> Issued by the passport office within the last 3-6 months (Requires Apostille).</li>
                <li>Proof of Financial Means (Bank statements showing approx €7,500 - €8,500)</li>
                <li>Comprehensive Health Insurance (Must be a specific Spanish provider like Sanitas or Adeslas, with zero copay).</li>
                <li>Proof of Accommodation in Spain</li>
                <li>Academic Transcripts & Degrees (Apostilled)</li>
              </ul>
            </div>
            ...
            <div id="careers" className="scroll-section">
              ...
              <p>Spain has recently updated its immigration laws to be much more favorable for international students, making it easier to gain European work experience.</p>
              
              <h3>Updated Part-Time Work Rules</h3>
              <p>In a massive recent update, international students holding a valid Spanish TIE (student residence card) are now legally allowed to work up to <strong>30 hours per week</strong> during their studies, provided the work hours do not conflict with their academic schedule. This is a significant increase from previous limits, allowing students to easily cover living expenses.</p>

              <div className="content-highlight">
                <p><strong>The 1-Year Job Search Visa:</strong> Graduates from Spanish higher education institutions are legally entitled to apply for the "Autorización de residencia para la búsqueda de empleo" (Job Search Residence Permit). This grants you a full <strong>12 months</strong> to stay in Spain to find a job suited to your qualifications or to start an entrepreneurial project. Once you secure a contract, you transition to a standard Spanish Work Permit.</p>
              </div>
            </div>
            ...
            <div id="faqs" className="scroll-section">
              ...
              <div className="faq-card">
                <h4>Do I need an IELTS score to study in Spain?</h4>
                <p>It depends heavily on the institution. While some public universities might request a standardized test, many highly popular private universities and business schools (like UCAM, EU Business School, and GBSB) will accept Indian students based on a Medium of Instruction (MOI) letter and a Skype interview.</p>
              </div>
              
              <div className="faq-card">
                <h4>What is the Homologación process?</h4>
                <p>Homologación is the official recognition of your foreign (Indian) degree by the Spanish Ministry of Education, verifying it is equivalent to a Spanish degree. This is often required if you are applying to traditional Public Universities, but is frequently bypassed if applying to Private Business Schools.</p>
              </div>

              <div className="faq-card">
                <h4>Is it absolutely necessary to learn Spanish?</h4>
                <p>To study your English-taught degree? No. To survive daily life? It helps, but you can manage with English in big cities like Barcelona and Madrid. However, if you intend to utilize your 1-Year Job Search Visa to find permanent employment in Spain, learning conversational Spanish is absolutely critical to your success.</p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#4B5563", margin: 0, maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
              Every country offers unique opportunities. Compare Spain with other top global study destinations to find your perfect fit.
            </p>
          </div>
          ...
          <div className="explore-track">
            ...
            <Link href="/countries" className="explore-all-btn">
              <span style={{ fontSize: "15px", fontWeight: 800 }}>Explore All 25+ Destinations</span>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, flex: "1 1 400px" }}>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 900, color: "white", letterSpacing: "-0.5px", margin: "0 0 16px" }}>
                Ready to Apply to Spain?
              </h2>
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.6, maxWidth: "480px" }}>
                Connect with our certified experts to secure your admission, perfectly organize your Apostilled and translated documents, and successfully lodge your Spanish Student Visa.
              </p>
            </div>
