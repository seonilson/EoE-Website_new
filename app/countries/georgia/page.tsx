...
// ── Data: Quick Facts ─────────────────────────────────────────
const quickFacts = [
  { icon: "🏛️", label: "Capital", value: "Tbilisi" },
  { icon: "💵", label: "Currency", value: "GEL (Georgian Lari)" },
  { icon: "🗣️", label: "Language", value: "Georgian & English" },
  { icon: "☀️", label: "Weather", value: "Moderate (Four Seasons)" },
  { icon: "🎓", label: "Top Intakes", value: "September & February" },
];

// ── Data: Section Navigation ──────────────────────────────────
const tabsData = [
  { id: "overview", icon: "🌍", label: "Why Georgia?" },
...
//  GEORGIA MASTER PAGE
// ═══════════════════════════════════════════════════════════════
export default function CountryGeorgiaPage() {
  useEffect(() => { document.title = "Study in Georgia 2026 — MBBS, Student Visa & Universities | Edification Overseas"; }, []);
        ...
        <div ref={heroRef.ref} className="hero-inner" style={{ maxWidth: "1280px", width: "100%", margin: "0 auto", padding: "20px 24px 60px", position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div className="hero-left-col" style={{ flex: "1 1 550px" }}>
            ...
            <p style={{
              ...
              Your premier gateway to medical excellence. A <strong>Georgia Study Visa</strong> is highly sought-after by Indian students for incredibly affordable, <strong>NMC-approved MBBS and Nursing degrees</strong>. Enjoy English-taught programs in a highly safe European environment with <strong>no IELTS required</strong>.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px", aspectRatio: "1/1", animation: "float1 6s infinite ease-in-out" }}>
              <Image 
                src="/images/monuments/georgia.png" 
                alt="Georgia Monument" 
                fill 
            ...
            <div style={{ position: "absolute", top: "10%", right: "10%", width: "90px", height: "90px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", zIndex: 9, animation: "float2 7s infinite reverse", overflow: "hidden", boxShadow: "0 16px 40px rgba(0,0,0,0.3)" }}>
               <Image src="/images/flags/ge.png" alt="Georgia Flag" fill style={{ objectFit: "cover" }} />
            </div>
        ...
        <div className="content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#022C45", margin: 0, letterSpacing: "-0.5px" }}>
              Your Complete Guide to Education in Georgia
            </h2>
          </div>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div id="overview" className="scroll-section">
              <h2>Why Study in Georgia? The Preferred Medical Destination</h2>
              <p>Georgia has rapidly become the absolute favorite destination for Indian students aiming to study medicine and healthcare. Situated at the crossroads of Europe and Asia, a <strong>Georgia Study Visa</strong> offers a completely secure environment, 100% English-taught programs, and degrees recognized by global medical councils.</p>
              
              <h3>Key Advantages of Education in Georgia</h3>
              <div className="info-grid">
                <div className="info-card">
                  <h4>🩺 NMC & WHO Approved</h4>
                  <p>Medical degrees from top Georgian universities are fully recognized by the National Medical Commission (India) and the World Health Organization.</p>
                </div>
                <div className="info-card">
                  <h4>🛡️ High Safety Rankings</h4>
                  <p>Georgia consistently ranks as one of the safest countries in the world, making it highly preferred by Indian parents for both male and female students.</p>
                </div>
                <div className="info-card">
                  <h4>🚫 No IELTS Required</h4>
                  <p>Admissions are straightforward. Indian students are not required to clear IELTS or PTE to secure a seat or visa in Georgia.</p>
                </div>
                <div className="info-card">
                  <h4>💰 Affordable European Living</h4>
                  <p>Experience a high-quality European standard of living and education at a fraction of the cost compared to the UK, USA, or Australia.</p>
                </div>
              </div>
            </div>
            ...
            <div id="institutions" className="scroll-section">
              <h2>Top Universities in Georgia</h2>
              <p>Georgia boasts a robust network of state-funded and premium private universities that are globally accredited and highly accustomed to hosting Indian students.</p>
              
              <h3>Top Medical Universities (MBBS & Nursing)</h3>
              <p>These institutions are the primary choice for Indian medical aspirants:</p>
              <div className="course-tags">
                <span className="course-tag-blue">🏛️ Tbilisi State Medical University (TSMU)</span>
                <span className="course-tag-blue">🏛️ Batumi Shota Rustaveli State University</span>
                <span className="course-tag-blue">🏛️ Grigol Robakidze University (GRUNI)</span>
              </div>

              <h3>Top Private & General Universities</h3>
              <p>Highly reputed for Business, IT, Humanities, and modern healthcare infrastructure:</p>
              <div className="course-tags">
                <span className="course-tag">🏫 University of Georgia (UG)</span>
                <span className="course-tag">🏫 International Black Sea University (IBSU)</span>
                <span className="course-tag">🏫 Georgian American University (GAU)</span>
                <span className="course-tag">🏫 Caucasus University</span>
                <span className="course-tag">🏫 Ilia State University</span>
                <span className="course-tag">🏫 Georgian International University (GIU)</span>
              </div>
              
              <h3>Estimated Financial Requirements</h3>
              <p>Studying in Georgia is highly cost-effective, providing excellent value for money with high-quality clinical exposure.</p>
              ...
              <div className="stat-grid">
                ...
                <div className="stat-card" style={{ background: "#fff5ee", borderColor: "rgba(241,97,1,0.3)" }}>
                  <div className="stat-value" style={{ color: "#F16101" }}>$3k - $4k</div>
            ...
            <div id="courses" className="scroll-section">
              <h2>High-Demand Courses in Georgia</h2>
              <p>While Georgia offers a variety of programs, it is universally recognized as a powerhouse for medical and healthcare education for international students.</p>
              
              <h3>Medicine & Healthcare</h3>
              <p>The 6-Year MD (equivalent to MBBS in India) is the flagship program. It is 100% English-taught and strictly follows European credit systems.</p>
              <div className="course-tags">
                <span className="course-tag">🩺 General Medicine (MBBS / MD)</span>
                <span className="course-tag">🏥 Nursing</span>
                <span className="course-tag">🦷 Dentistry</span>
                <span className="course-tag">💊 Pharmacy</span>
              </div>

              <h3>Business & Information Technology</h3>
              <p>Georgian universities like IBSU and Caucasus University offer excellent, modern programs for corporate and tech careers.</p>
              <div className="course-tags">
            ...
            <div id="admissions" className="scroll-section">
              <h2>Navigating the Georgian Visa Process</h2>
              <p>The admission process in Georgia includes a unique step: obtaining a decree from the <strong>Ministry of Education and Science</strong>. We handle this entire process seamlessly for you.</p>
              ...
              <div className="timeline">
                ...
                <div className="timeline-step">
                  ...
                  <div className="step-content"><strong>Ministry Decree:</strong> The university submits your documents to the National Center for Educational Quality Enhancement (EQE) to issue a formal Ministry Decree recognizing your admission.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">3</div>
                  <div className="step-content"><strong>Visa Application:</strong> Once the Decree is issued, we apply for your Georgian National Study Visa (D3 Category) either via the e-Visa portal or the local embassy, depending on the current guidelines.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">4</div>
                  <div className="step-content"><strong>Arrival in Georgia:</strong> Travel to Tbilisi. The university will assist with your airport pickup and hostel allocation.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">5</div>
                  <div className="step-content"><strong>Temporary Residence Card (TRC):</strong> Within the first few weeks of your arrival, you will apply for your TRC, which serves as your legal ID card during your entire study period.</div>
                </div>
              </div>
            </div>
            ...
            <div id="documents" className="scroll-section">
              ...
              <p>Georgia requires specific documents to be officially Apostilled in India prior to submission for the Ministry Decree and Visa.</p>
              ...
              <ul className="doc-list">
                ...
                <li>Bank Statement showing latest funds (approx USD 3,000 - 4,000)</li>
            ...
            <div id="careers" className="scroll-section">
              ...
              <p>Because medical studies are highly intensive, work rules are structured to ensure students maintain their academic focus.</p>
              
              <div className="content-highlight">
                <p><strong>Part-Time Work Rules:</strong> International students holding a valid TRC are generally permitted to work part-time in Georgia. However, due to the rigorous schedule of the 6-year medical degree, universities heavily advise students to focus entirely on their clinical and academic studies.</p>
              </div>

              <h3>Post-Study Medical Pathways</h3>
              <p>Upon graduation, Indian students are awarded an MD degree (equivalent to MBBS). To practice medicine in India, graduates must pass the <strong>FMGE / NEXT exam</strong>. Additionally, because Georgian degrees are globally recognized, many students use them as a stepping stone to appear for the <strong>USMLE (USA)</strong> or <strong>PLAB (UK)</strong> exams for international medical residencies.</p>
            </div>
            ...
            <div id="faqs" className="scroll-section">
              ...
              <div className="faq-card">
                <h4>Is NEET mandatory to study MBBS in Georgia?</h4>
                <p>Yes. If you are an Indian citizen who intends to return to India to practice medicine after your graduation, the National Medical Commission (NMC) strictly requires you to have qualified the NEET-UG exam before taking admission abroad.</p>
              </div>

              <div className="faq-card">
                <h4>Are the MBBS programs in Georgia taught in English?</h4>
                <p>Absolutely. The 6-year MD/MBBS programs for international students are taught entirely in English. You will, however, learn the local Georgian language as a subject so you can comfortably interact with local patients during your hospital training.</p>
              </div>
              
              <div className="faq-card">
                <h4>Is an IELTS or PTE score required?</h4>
                <p>No. Universities in Georgia and the visa authorities do not require IELTS or PTE scores from Indian students. Admissions are based on your 12th standard marks and NEET qualification.</p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#4B5563", margin: 0, maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
              Every country offers unique opportunities. Compare Georgia with other top global study destinations to find your perfect fit.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, flex: "1 1 400px" }}>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 900, color: "white", letterSpacing: "-0.5px", margin: "0 0 16px" }}>
                Ready to Apply to Georgia?
              </h2>
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.6, maxWidth: "480px" }}>
                Connect with our certified experts to secure your medical university seat, obtain your Ministry Decree, and confidently lodge your Georgian Study Visa.
              </p>
            </div>
