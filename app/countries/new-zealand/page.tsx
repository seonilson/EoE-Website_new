...
const quickFacts = [
  ...
  { icon: "💵", label: "Currency", value: "NZD (New Zealand Dollar)" },
  { icon: "🗣️", label: "Language", value: "English & Māori" },
  { icon: "🍃", label: "Weather", value: "Temperate Maritime" },
  { icon: "🎓", label: "Top Intakes", value: "February & July" },
];

// ── Data: Section Navigation ──────────────────────────────────
const tabsData = [
  { id: "overview", icon: "🥝", label: "Why New Zealand?" },
  { id: "institutions", icon: "🏛️", label: "Top Institutes" },
  { id: "courses", icon: "🎯", label: "Top Courses" },
  { id: "admissions", icon: "📝", label: "FTS & Visa Process" },
  { id: "documents", icon: "📂", label: "Documents" },
  { id: "careers", icon: "💼", label: "PSW & Green List" },
...
// ═══════════════════════════════════════════════════════════════
//  NEW ZEALAND MASTER PAGE
// ═══════════════════════════════════════════════════════════════
export default function CountryNewZealandPage() {
  useEffect(() => { document.title = "Study in New Zealand 2026 — Student Visa, Work Rights & PR | Edification Overseas"; }, []);
        ...
        <div ref={heroRef.ref} className="hero-inner" style={{ maxWidth: "1280px", width: "100%", margin: "0 auto", padding: "20px 24px 60px", position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div className="hero-left-col" style={{ flex: "1 1 550px" }}>
            <div style={{
              ...
              <span style={{ fontSize: "12px", fontWeight: 800, color: "rgba(255,255,255,0.9)", letterSpacing: "0.4px", textTransform: "uppercase" }}>
                The Ultimate Pacific Destination
              </span>
            </div>
            ...
            <p style={{
              ...
              Experience an unparalleled lifestyle and academic excellence. A <strong>New Zealand Student Visa</strong> offers Indian students access to highly affordable tech institutes, secure funding through the <strong>FTS</strong>, and direct pathways to PR via the highly coveted <strong>Green List Occupations</strong>.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px", aspectRatio: "1/1", animation: "float1 6s infinite ease-in-out" }}>
              <Image 
                src="/images/monuments/newzealand.png" 
                alt="New Zealand Monument Sky Tower" 
                fill 
            ...
            <div style={{ position: "absolute", top: "10%", right: "10%", width: "90px", height: "90px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", zIndex: 9, animation: "float2 7s infinite reverse", overflow: "hidden", boxShadow: "0 16px 40px rgba(0,0,0,0.3)" }}>
               <Image src="/images/flags/nz.png" alt="New Zealand Flag" fill style={{ objectFit: "cover" }} />
            </div>
            ...
            <div style={{ position: "absolute", top: "40px", left: "0px", zIndex: 3, animation: "float2 5s infinite" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontSize: "10px", color: "#07CBEB", textTransform: "uppercase", fontWeight: 800 }}>Migration</span>
                  <span style={{ fontSize: "14px", fontWeight: 800, color: "#ffffff" }}>Green List Roles</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ position: "absolute", bottom: "60px", right: "0px", zIndex: 3, animation: "float1 7s infinite reverse" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  <span style={{ fontSize: "14px", fontWeight: 800, color: "#ffffff" }}>Up to 3-Year PSW</span>
                </div>
              </div>
            </div>
        ...
        <div className="content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#022C45", margin: 0, letterSpacing: "-0.5px" }}>
              Your Complete Guide to Education in New Zealand
            </h2>
          </div>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div id="overview" className="scroll-section">
              <h2>Why Study in New Zealand? The Safest Path to Success</h2>
              <p>New Zealand is globally celebrated for its breathtaking landscapes, highly welcoming culture, and incredibly secure environment for international students. A <strong>New Zealand Student Visa</strong> offers Indian students practical, industry-focused education and distinct pathways to permanent residency through the highly beneficial Green List.</p>
              
              <h3>Key Advantages of Education in New Zealand</h3>
              <div className="info-grid">
                <div className="info-card">
                  <h4>🌟 The Green List Occupations</h4>
                  <p>Graduating in a field on the Green List (like IT, Engineering, or Healthcare) provides a fast-tracked, highly secure pathway to permanent residency in NZ.</p>
                </div>
                <div className="info-card">
                  <h4>💼 Post-Study Work Visa</h4>
                  <p>Depending on your qualification level, international graduates can easily secure a Post-Study Work (PSW) Visa for up to 3 years to gain global experience.</p>
                </div>
                <div className="info-card">
                  <h4>🛡️ Financial Security via FTS</h4>
                  <p>The unique Fund Transfer Scheme (FTS) guarantees that your living expenses are securely held in a New Zealand bank, ensuring your visa approval goes smoothly.</p>
                </div>
                <div className="info-card">
                  <h4>🎓 Extremely Practical Education</h4>
                  <p>Unlike purely theoretical systems, NZ heavily promotes Institutes of Technology and Polytechnics (ITPs) that focus entirely on making you job-ready from day one.</p>
                </div>
              </div>
            </div>
            ...
            <div id="institutions" className="scroll-section">
              <h2>Top Universities & Private Training Institutes (PTEs)</h2>
              <p>New Zealand has a very clear, quality-assured education framework. Students can choose between traditional Public Universities and highly affordable, employment-focused PTEs and ITPs.</p>
              
              <h3>Top Public Universities</h3>
              <p>Globally ranked, research-intensive institutions favored for Master's and PhD programs:</p>
              <div className="course-tags">
                <span className="course-tag-blue">🏛️ University of Auckland</span>
                <span className="course-tag-blue">🏛️ Auckland University of Technology (AUT)</span>
                <span className="course-tag-blue">🏛️ Massey University</span>
                <span className="course-tag-blue">🏛️ University of Waikato</span>
                <span className="course-tag-blue">🏛️ Lincoln University</span>
              </div>

              <h3>Highly Popular PTEs & Institutes of Technology</h3>
              <p>These institutes are massively popular in the Indian market for their affordable fees, practical diplomas, and excellent industry placements:</p>
              <div className="course-tags">
                <span className="course-tag">🏫 SIT - Southern Institute of Technology</span>
                <span className="course-tag">🏫 NZMA - New Zealand Management Academies</span>
                <span className="course-tag">🏫 Yoobee Colleges</span>
                <span className="course-tag">🏫 PIHMS - Pacific Int. Hotel Management School</span>
                <span className="course-tag">🏫 ICL Education Group</span>
                <span className="course-tag">🏫 New Zealand Tertiary College (NZTC)</span>
                <span className="course-tag">🏫 Aspire2 International</span>
              </div>
              
              <h3>Estimated Financial Requirements</h3>
              <p>Immigration New Zealand (INZ) has very clear financial expectations to ensure students are fully supported during their studies.</p>
              
              <div className="stat-grid">
                <div className="stat-card">
                  <div className="stat-value">NZD 18k - 25k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Diplomas & PTEs)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">NZD 28k - 40k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Universities / Masters)</div>
                </div>
                <div className="stat-card" style={{ background: "#fff5ee", borderColor: "rgba(241,97,1,0.3)" }}>
                  <div className="stat-value" style={{ color: "#F16101" }}>NZD 20,000</div>
                  <div className="stat-label">Mandatory Living Funds<br/>(Per Year FTS Proof)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">NZD 1,666</div>
                  <div className="stat-label">Monthly Payout<br/>(From FTS Account)</div>
                </div>
              </div>

              <div className="content-highlight">
                <p><strong>The Fund Transfer Scheme (FTS):</strong> To secure your visa safely, Indian students are highly encouraged to use the FTS. Under this scheme, you transfer exactly <strong>NZD 20,000</strong> to an approved New Zealand bank (like ANZ) prior to the visa stamp. The bank then releases a set amount to you monthly to cover your living costs.</p>
              </div>
            </div>

            {/* CHAPTER 3: COURSES */}
            <div id="courses" className="scroll-section">
              <h2>High-Demand Courses in New Zealand</h2>
              <p>Aligning your studies with New Zealand’s <strong>Green List</strong> is the smartest strategy. These fields face critical shortages and offer rapid pathways to residency.</p>
              
              <h3>Information Technology & Digital Arts</h3>
              <p>Institutes like Yoobee and AUT excel in producing tech talent that the local market desperately needs.</p>
              <div className="course-tags">
                <span className="course-tag">💻 Software Engineering</span>
                <span className="course-tag">🎨 Animation & Game Design</span>
                <span className="course-tag">🔒 Cyber Security & Networking</span>
              </div>

              <h3>Hospitality & Culinary Arts</h3>
              <p>With tourism driving the economy, schools like PIHMS and NZMA provide guaranteed internships in top resorts.</p>
              <div className="course-tags">
                <span className="course-tag">🏨 Hotel & Resort Management</span>
                <span className="course-tag">👨‍🍳 Culinary Arts</span>
                <span className="course-tag">✈️ Tourism Management</span>
              </div>

              <h3>Engineering, Construction & Healthcare</h3>
              <div className="course-tags">
                <span className="course-tag">🏗️ Construction Management</span>
                <span className="course-tag">⚡ Electrical Engineering</span>
                <span className="course-tag">🏥 Early Childhood Education & Nursing</span>
              </div>
            </div>

            {/* CHAPTER 4: ADMISSIONS & VISAS */}
            <div id="admissions" className="scroll-section">
              <h2>Navigating the AIP & NZ Visa Process</h2>
              <p>The New Zealand student visa process is unique because it features an <strong>AIP (Approval in Principle)</strong> stage, ensuring your visa is practically guaranteed before you transfer heavy tuition fees.</p>
              
              <h3>The Step-by-Step Visa Process</h3>
              <div className="timeline">
                <div className="timeline-step">
                  <div className="step-num">1</div>
                  <div className="step-content"><strong>Offer of Place:</strong> Submit your academics, valid IELTS/PTE scores, and SOP to receive a Conditional Offer of Place from your chosen institute.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">2</div>
                  <div className="step-content"><strong>Financial Preparation & Visa Lodgment:</strong> Prepare your family's financial documents (ITRs, Education loans) and submit your complete visa application online to Immigration New Zealand (INZ).</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">3</div>
                  <div className="step-content"><strong>AIP (Approval in Principle):</strong> INZ reviews your file and issues an AIP. This means your visa is approved, subject only to paying your fees.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">4</div>
                  <div className="step-content"><strong>Fee Transfer & FTS:</strong> After receiving the AIP, you transfer your 1st-year tuition directly to the college and transfer your NZD 20,000 living costs into your FTS bank account.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">5</div>
                  <div className="step-content"><strong>Final E-Visa:</strong> Submit the payment receipts to INZ. Your final electronic Student Visa is issued, and you are ready to fly!</div>
                </div>
              </div>
            </div>
            ...
            <div id="documents" className="scroll-section">
              ...
              <p>Immigration New Zealand is highly analytical. Your financial proofs and your statement of intent must be flawless.</p>
              ...
              <ul className="doc-list">
                ...
                <li><strong>Valid IELTS or PTE Scorecard</strong> (Mandatory for almost all courses)</li>
                <li><strong>Police Clearance Certificate (PCC)</strong> from India</li>
                <li><strong>Medical Certificate & Chest X-Ray</strong> from an INZ panel physician</li>
                <li>Statement of Purpose (SOP) explaining your study intent in detail</li>
                <li>Financial Proofs (Education Loan, ITRs, 6-month bank statements)</li>
                <li>Offer of Place from an NZQA-approved institution</li>
              </ul>
            </div>

            {/* CHAPTER 6: CAREERS */}
            <div id="careers" className="scroll-section">
              <h2>Post-Study Work (PSW) and The Green List</h2>
              <p>New Zealand offers a highly transparent pathway from studying to working and eventually settling, provided you choose your level of study carefully.</p>
              
              <h3>Part-Time Work During Studies</h3>
              <p>International students in New Zealand are legally allowed to work up to <strong>20 hours per week</strong> during the academic term, and full-time during scheduled holidays. With a high minimum wage, students can comfortably manage their monthly expenses.</p>

              <div className="content-highlight">
                <p><strong>Post-Study Work Visa (Up to 3 Years):</strong> If you study a Bachelor's degree, Master's degree, or PhD (Level 7 or above), you are generally entitled to a 3-year Post-Study Work Visa. If you study a Diploma (Level 4-6), you are only eligible for a PSW if your qualification directly leads to an occupation on the highly-demanded <strong>Green List</strong>.</p>
              </div>

              <h3>The Green List Advantage</h3>
              <p>The Green List features occupations that are in critical shortage in New Zealand (like Civil Engineers, Software Developers, and Early Childhood Teachers). Graduating into one of these roles not only secures your PSW but provides a fast-tracked, prioritized application for permanent residency.</p>
            </div>
            ...
            <div id="faqs" className="scroll-section">
              ...
              <div className="faq-card">
                <h4>What exactly is the FTS (Fund Transfer Scheme)?</h4>
                <p>The FTS is a highly secure financial system designed for students from countries like India. Instead of showing old funds in an Indian bank account, you transfer your required living costs (NZD 20,000) directly into an NZ bank account in your name. This proves to immigration that you definitely have the money to survive, heavily increasing your visa success rate.</p>
              </div>
              
              <div className="faq-card">
                <h4>Is an IELTS or PTE score strictly required for New Zealand?</h4>
                <p>Yes. While there are very rare exceptions, the vast majority of universities and PTEs, as well as Immigration New Zealand, require a valid English proficiency score (IELTS, PTE, or TOEFL) from Indian applicants.</p>
              </div>

              <div className="faq-card">
                <h4>What does AIP mean?</h4>
                <p>AIP stands for Approval in Principle. It is the most beautiful part of the NZ visa process. It means the immigration officer has assessed your file and approved your visa, and you only need to actually pay your heavy college tuition fees AFTER you get this approval.</p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#4B5563", margin: 0, maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
              Every country offers unique opportunities. Compare New Zealand with other top global study destinations to find your perfect fit.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, flex: "1 1 400px" }}>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 900, color: "white", letterSpacing: "-0.5px", margin: "0 0 16px" }}>
                Ready to Apply to New Zealand?
              </h2>
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.6, maxWidth: "480px" }}>
                Connect with our certified experts to secure your Offer of Place, perfectly prepare your FTS documentation, and successfully achieve your AIP Visa status.
              </p>
            </div>
