...
// ── Data: Quick Facts ─────────────────────────────────────────
const quickFacts = [
  { icon: "🏛️", label: "Capital", value: "Valletta" },
  { icon: "💶", label: "Currency", value: "EUR (Euro)" },
  { icon: "🗣️", label: "Language", value: "English & Maltese" },
  { icon: "☀️", label: "Weather", value: "Mediterranean (Warm & Sunny)" },
  { icon: "🎓", label: "Top Intakes", value: "October, February, June" },
];

// ── Data: Section Navigation ──────────────────────────────────
const tabsData = [
  { id: "overview", icon: "🌍", label: "Why Malta?" },
  { id: "institutions", icon: "🏛️", label: "Institutes & Fees" },
...
//  MALTA MASTER PAGE
// ═══════════════════════════════════════════════════════════════
export default function CountryMaltaPage() {
  useEffect(() => { document.title = "Study in Malta 2026 — Student Visa, EU Degree & Work Rights | Edification Overseas"; }, []);
        ...
        <div ref={heroRef.ref} className="hero-inner" style={{ maxWidth: "1280px", width: "100%", margin: "0 auto", padding: "20px 24px 60px", position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div className="hero-left-col" style={{ flex: "1 1 550px" }}>
            ...
            <p style={{
              ...
              Unlock the ultimate European opportunity. A <strong>Malta Study Visa</strong> provides Indian students full access to the <strong>Schengen Zone</strong>, affordable tuition fees, and high-quality education in an <strong>English-speaking EU country</strong>. We offer guaranteed pathways with <strong>no IELTS/PTE required</strong> and accept students directly after the <strong>10th standard</strong>.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px", aspectRatio: "1/1", animation: "float1 6s infinite ease-in-out" }}>
              <Image 
                src="/images/monuments/malta.png" 
                alt="Malta Monument" 
                fill 
            ...
            <div style={{ position: "absolute", top: "10%", right: "10%", width: "90px", height: "90px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", zIndex: 9, animation: "float2 7s infinite reverse", overflow: "hidden", boxShadow: "0 16px 40px rgba(0,0,0,0.3)" }}>
               <Image src="/images/flags/mt.png" alt="Malta Flag" fill style={{ objectFit: "cover" }} />
            </div>
            ...
            <div style={{ position: "absolute", bottom: "60px", right: "0px", zIndex: 3, animation: "float1 7s infinite reverse" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                <span style={{ fontSize: "20px" }}>⚡</span>
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontSize: "10px", color: "#07CBEB", textTransform: "uppercase", fontWeight: 800 }}>Easy Admissions</span>
                  <span style={{ fontSize: "14px", fontWeight: 800, color: "#ffffff" }}>10th Pass Accepted</span>
                </div>
              </div>
            </div>
        ...
        <div className="content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#022C45", margin: 0, letterSpacing: "-0.5px" }}>
              Your Complete Guide to Education in Malta
            </h2>
          </div>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div id="overview" className="scroll-section">
              <h2>Why Study in Malta? The Ultimate European Pathway</h2>
              <p>For Indian students, studying in Malta provides an exceptional entry point into Europe. Malta is one of the very few countries in the European Union where English is an official, primary language. A <strong>Malta Student Visa</strong> offers a unique combination of high academic standards, low living costs, and incredible freedom to travel across Europe.</p>
              
              <h3>Key Advantages for Indian Students</h3>
              <div className="info-grid">
                <div className="info-card">
                  <h4>🗺️ Full Schengen Access</h4>
                  <p>As a member of the Schengen zone, your Maltese student residence card allows you to easily travel to 27 other European countries without a separate visa.</p>
                </div>
                <div className="info-card">
                  <h4>🗣️ English Speaking Nation</h4>
                  <p>Unlike Germany or France, you do not need to learn a new language to survive. English is spoken by almost everyone in Malta, making daily life and studies very easy.</p>
                </div>
                <div className="info-card">
                  <h4>🎓 10th Pass Admissions</h4>
                  <p>Malta is incredibly flexible. Students who have only completed their 10th standard can directly apply for specialized Foundation and Diploma pathways.</p>
                </div>
                <div className="info-card">
                  <h4>🚫 No IELTS or PTE Required</h4>
                  <p>Most private institutes in Malta will grant admission based on a Medium of Instruction (MOI) letter or a basic internal English interview, completely bypassing strict IELTS tests.</p>
                </div>
              </div>
            </div>
            ...
            <div id="institutions" className="scroll-section">
              <h2>Top Institutes, Colleges & Cost of Living</h2>
              <p>Malta is home to an excellent mix of highly respected Public Universities and dynamic Private Colleges that focus heavily on modern, employable skills.</p>
              
              <h3>Public Universities & Institutes</h3>
              <p>These government-backed institutions are world-renowned and offer highly prestigious degrees:</p>
              <div className="course-tags">
                <span className="course-tag-blue">🏛️ University of Malta</span>
                <span className="course-tag-blue">🏛️ MCAST (Malta College of Arts, Science & Technology)</span>
              </div>

              <h3>Top Private Colleges</h3>
              <p>These institutions are extremely popular choices for international students due to their flexible admissions (No IELTS, 10th pass accepted) and affordable fees:</p>
              <div className="course-tags">
                <span className="course-tag">🏫 La Valletta Institute</span>
                <span className="course-tag">🏫 Malita International College</span>
                <span className="course-tag">🏫 Global College Malta</span>
                <span className="course-tag">🏫 EIE Business School</span>
                <span className="course-tag">🏫 London School of Commerce (LSC) Malta</span>
                <span className="course-tag">🏫 IDEA Academy</span>
              </div>
              
              <h3>Estimated Financial Requirements</h3>
              <p>Compared to the UK or USA, studying in Malta is highly budget-friendly.</p>
              
              <div className="stat-grid">
                <div className="stat-card">
                  <div className="stat-value">€ 4k - € 6k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Diplomas/Certificates)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">€ 6k - € 9k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Bachelors Degrees)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">€ 7k - € 10k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Masters Programs)</div>
                </div>
                <div className="stat-card">
                  <div className="stat-value">€ 400 - € 600</div>
            ...
            <div id="courses" className="scroll-section">
              <h2>High-Demand Courses in Malta</h2>
              <p>Malta's economy is heavily driven by tourism, iGaming, and financial services, making specific courses highly valuable for future employment.</p>
              
              <h3>Hospitality & Tourism</h3>
              <p>As a Mediterranean holiday destination, Malta has a massive demand for trained hospitality professionals. These courses often come with great part-time job opportunities.</p>
              <div className="course-tags">
                <span className="course-tag">🏨 Hotel Management</span>
                <span className="course-tag">✈️ Travel & Tourism</span>
                <span className="course-tag">👨‍🍳 Culinary Arts</span>
              </div>

              <h3>Business & Financial Services</h3>
              <div className="course-tags">
                <span className="course-tag">📈 Business Administration (BBA/MBA)</span>
                <span className="course-tag">💰 Global Finance & Accounting</span>
                <span className="course-tag">📦 Supply Chain Management</span>
              </div>

              <h3>IT & Digital Gaming</h3>
              <p>Malta is known as the "iGaming Capital of Europe." IT professionals are in high demand.</p>
              <div className="course-tags">
                <span className="course-tag">🎮 Game Development</span>
            ...
            <div id="admissions" className="scroll-section">
              <h2>Navigating the Malta Visa Process</h2>
              <p>The student visa process for Malta is systematic. Indian students apply for a <strong>National D-Visa</strong> through VFS Global in India. After arriving in Malta, you convert this visa into an official E-Residence Card.</p>
              
              <h3>The Step-by-Step Visa Process</h3>
              <div className="timeline">
                <div className="timeline-step">
                  <div className="step-num">1</div>
                  <div className="step-content"><strong>Secure Offer Letter:</strong> Submit your basic academics and passport. 10th pass students and those without IELTS are fully accepted.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">2</div>
                  <div className="step-content"><strong>Pay Tuition Deposit:</strong> Pay the required initial tuition fee deposit to the college to receive your official Acceptance Letter and Visa Support Letter.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">3</div>
                  <div className="step-content"><strong>Prepare Financials & Documents:</strong> Compile your bank statements, travel insurance, and flight itineraries. Documents do <em>not</em> usually require Apostille for the visa stage.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">4</div>
                  <div className="step-content"><strong>VFS Visa Submission:</strong> Attend your appointment at VFS Global in India to submit your biometric data and hard copy file.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">5</div>
                  <div className="step-content"><strong>Arrival & E-Residence:</strong> Travel to Malta on your D-Visa. Once there, your college will assist you in applying to Identity Malta for your official E-Residence Card, which grants you Schengen travel rights.</div>
                </div>
              </div>
            </div>
            ...
            <div id="documents" className="scroll-section">
              ...
              <p>Having a perfectly organized document file is the key to a fast visa approval through VFS.</p>
              
              <h3>Required Admission & Visa Documents</h3>
              <ul className="doc-list">
                <li>Valid Passport (Must have at least 2 blank pages)</li>
                <li>All Academic Transcripts (10th pass certificate is acceptable for Diplomas)</li>
                <li>Official Acceptance Letter & Receipt of Fee Payment from the College</li>
                <li>Bank Statement (Showing sufficient living funds, approx €6,000 - €8,000)</li>
                <li>Comprehensive Travel & Medical Insurance</li>
                <li>Confirmed Flight Itinerary & Accommodation Proof in Malta</li>
                <li>Updated Curriculum Vitae (CV) & Statement of Purpose (SOP)</li>
              </ul>
            </div>

            {/* CHAPTER 6: CAREERS */}
            <div id="careers" className="scroll-section">
              <h2>Part-Time Work and Career Opportunities</h2>
              <p>Malta is actively looking for young professionals to fuel its growing economy. Student work rights are very generous.</p>
              
              <h3>Part-Time Work During Studies</h3>
              <p>International students in Malta are legally permitted to work part-time for up to <strong>20 hours per week</strong>. Unlike some other countries, finding a part-time job in Malta's booming hospitality and retail sectors is relatively easy, especially because everyone speaks English.</p>

              <h3>Post-Study Work Rights</h3>
              <p>After successfully graduating from a higher education program in Malta, international students are eligible to extend their stay for up to <strong>9 months</strong> to search for a full-time job. Once you secure a job, your employer will sponsor you to switch to a standard Malta Work Permit.</p>
            </div>
            ...
            <div id="faqs" className="scroll-section">
              ...
              <div className="faq-card">
                <h4>Can I really apply if I only passed my 10th Standard?</h4>
                <p>Yes! Many private institutes in Malta offer recognized "Foundation" or "Level 3/4 Diploma" pathways specifically designed for students who have only completed their 10th standard. Upon completing the diploma, you can easily progress to a Bachelor's degree.</p>
              </div>
              
              <div className="faq-card">
                <h4>Is IELTS strictly mandatory for Malta?</h4>
                <p>No. While public universities like the University of Malta may have stricter rules, almost all private colleges will grant you admission without an IELTS or PTE score, provided you can clear a basic English interview or show a Medium of Instruction (MOI) letter.</p>
              </div>

              <div className="faq-card">
                <h4>Can I travel to other European countries while studying?</h4>
                <p>Absolutely. Once you arrive in Malta and receive your official Maltese E-Residence card, you have the legal right to travel freely across all 27 Schengen countries (including France, Germany, Italy, etc.) without needing any additional tourist visas.</p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#4B5563", margin: 0, maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
              Every country offers unique opportunities. Compare Malta with other top global study destinations to find your perfect fit.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, flex: "1 1 400px" }}>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 900, color: "white", letterSpacing: "-0.5px", margin: "0 0 16px" }}>
                Ready to Apply to Malta?
              </h2>
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.6, maxWidth: "480px" }}>
                Connect with our certified experts to secure your admission letter, prepare your financial documents, and successfully lodge your Schengen Student Visa.
              </p>
            </div>
