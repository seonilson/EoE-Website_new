...
// ── Data: Quick Facts ─────────────────────────────────────────
const quickFacts = [
  { icon: "🏛️", label: "Capital", value: "Port Louis" },
  { icon: "💵", label: "Currency", value: "MUR (Mauritian Rupee)" },
  { icon: "🗣️", label: "Language", value: "English & French" },
  { icon: "☀️", label: "Weather", value: "Tropical Paradise" },
  { icon: "🎓", label: "Top Intakes", value: "Feb, July & October" },
];

// ── Data: Section Navigation ──────────────────────────────────
const tabsData = [
  { id: "overview", icon: "🌴", label: "Why Mauritius?" },
  { id: "institutions", icon: "🏛️", label: "Institutes & Fees" },
  { id: "courses", icon: "🎯", label: "Top Courses" },
  { id: "admissions", icon: "📝", label: "Visa Process" },
  { id: "documents", icon: "📂", label: "Documents" },
  { id: "careers", icon: "💼", label: "Part-Time Work" },
        ...
        <div ref={heroRef.ref} className="hero-inner" style={{ maxWidth: "1280px", width: "100%", margin: "0 auto", padding: "20px 24px 60px", position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: "40px", flexWrap: "wrap" }}>
          ...
          <div className="hero-left-col" style={{ flex: "1 1 550px" }}>
            ...
            <p style={{
              ...
              Discover a tropical paradise with world-class education. A <strong>Mauritius Study Visa</strong> offers Indian students highly affordable tuition, an <strong>almost 100% visa approval rate</strong>, and globally recognized degrees with absolutely <strong>no IELTS or PTE requirements</strong>.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px", aspectRatio: "1/1", animation: "float1 6s infinite ease-in-out" }}>
              <Image 
                src="/images/monuments/mauritius.png" 
                alt="Mauritius Monument" 
                fill 
            ...
            <div style={{ position: "absolute", top: "10%", right: "10%", width: "90px", height: "90px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", zIndex: 9, animation: "float2 7s infinite reverse", overflow: "hidden", boxShadow: "0 16px 40px rgba(0,0,0,0.3)" }}>
               <Image src="/images/flags/mu.png" alt="Mauritius Flag" fill style={{ objectFit: "cover" }} />
            </div>
            ...
            <div style={{ position: "absolute", bottom: "60px", right: "0px", zIndex: 3, animation: "float1 7s infinite reverse" }}>
              <div style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.2)", padding: "12px 20px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 16px 40px rgba(0,0,0,0.2)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontSize: "10px", color: "#07CBEB", textTransform: "uppercase", fontWeight: 800 }}>Visa Success</span>
                  <span style={{ fontSize: "14px", fontWeight: 800, color: "#ffffff" }}>Almost 100%</span>
                </div>
              </div>
            </div>
        ...
        <div className="content-container">
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#022C45", margin: 0, letterSpacing: "-0.5px" }}>
              Your Complete Guide to Education in Mauritius
            </h2>
          </div>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div id="overview" className="scroll-section">
              <h2>Why Study in Mauritius? An Island of Opportunity</h2>
              <p>For Indian students, studying in Mauritius offers an unparalleled combination of affordability, high educational standards, and a culturally familiar environment. Known for its booming tourism and business sectors, a <strong>Mauritius Student Visa</strong> is incredibly straightforward to obtain, boasting an almost 100% success rate.</p>
              
              <h3>Key Advantages of Education in Mauritius</h3>
              <div className="info-grid">
                <div className="info-card">
                  <h4>🚫 Zero English Barriers</h4>
                  <p>Study in Mauritius without IELTS or PTE. Institutions evaluate your previous education to grant admissions.</p>
                </div>
                <div className="info-card">
                  <h4>🛡️ Guaranteed Visa Approval</h4>
                  <p>With simple financial requirements and no complex embassy interviews, the visa approval rate is almost 100%.</p>
                </div>
                <div className="info-card">
                  <h4>💰 Highly Cost-Effective</h4>
                  <p>Experience international standards of education at a fraction of the cost compared to the UK or Australia.</p>
                </div>
                <div className="info-card">
                  <h4>🌍 International Pathways</h4>
                  <p>Many institutions offer credit transfer facilities, allowing you to easily complete your degree in the UK, Australia, or Europe.</p>
                </div>
              </div>
            </div>
            ...
            <div id="institutions" className="scroll-section">
              ...
              <p>Mauritius is home to an excellent array of focused, professional institutes that cater specifically to international students seeking practical, industry-ready skills.</p>
              
              <h3>Top Academic Institutions</h3>
              <p>These institutions are extremely popular choices for Indian students due to their affordable fees and specialized curriculums:</p>
              <div className="course-tags">
                <span className="course-tag">🏫 Broad Horizons Ltd</span>
                <span className="course-tag">🏫 Stephens Business School</span>
                <span className="course-tag">🏫 Rushmore Business School</span>
                <span className="course-tag">🏫 JHTM</span>
                <span className="course-tag">🏫 Aura Institute of Business and Hospitality</span>
                <span className="course-tag">🏫 Sagittarius</span>
                <span className="course-tag">🏫 Vega Institute</span>
                <span className="course-tag">🏫 IIHTM Education</span>
              </div>
              
              <h3>Latest Financial Requirements & Show Funds</h3>
              <p>Mauritius is highly budget-friendly. To secure your visa, you must demonstrate sufficient funds to cover your initial stay and education.</p>
              
              <div className="stat-grid">
                <div className="stat-card">
                  <div className="stat-value">$3k - $5k</div>
                  <div className="stat-label">Avg. Tuition / Year<br/>(Diplomas/Bachelors)</div>
                </div>
                <div className="stat-card">
                ...
                <div className="stat-card" style={{ background: "#fff5ee", borderColor: "rgba(241,97,1,0.3)" }}>
                  <div className="stat-value" style={{ color: "#F16101" }}>$5k - $6k</div>
                  <div className="stat-label">Required Bank Balance<br/>(Show Money / Funds)</div>
                </div>
              </div>

              <div className="content-highlight">
                <p><strong>Latest Funds Update:</strong> To successfully secure a student visa, the Passport and Immigration Office (PIO) requires international students to show an available bank balance of approximately <strong>USD 5,000 to USD 6,000</strong> (or equivalent in INR) to ensure they can support themselves.</p>
              </div>
            </div>

            {/* CHAPTER 3: COURSES */}
            <div id="courses" className="scroll-section">
              <h2>High-Demand Courses in Mauritius</h2>
              <p>Given the island's strong economy and global tourist appeal, choosing a program aligned with local industry demands guarantees excellent career opportunities.</p>
              
              <h3>Hospitality, Tourism & Culinary Arts</h3>
              <p>This is a highly popular sector in Mauritius. A select few institutes incorporate internships into their curriculum, providing valuable hands-on experience.</p>
              <div className="course-tags">
                <span className="course-tag">🏨 Hotel Management</span>
                <span className="course-tag">✈️ Travel & Tourism</span>
                <span className="course-tag">👨‍🍳 Culinary Arts & Pastry</span>
              </div>
            ...
            <div id="admissions" className="scroll-section">
              <h2>Navigating the Mauritius Visa Process</h2>
              <p>The student visa process for Mauritius is stress-free. Your chosen institute handles the majority of the paperwork by applying on your behalf to the <strong>Passport and Immigration Office (PIO)</strong>.</p>
              
              <h3>The Step-by-Step Admission Process</h3>
              <div className="timeline">
                <div className="timeline-step">
                  <div className="step-num">1</div>
                  <div className="step-content"><strong>Secure Admission:</strong> Submit your basic academic documents and passport to receive your official offer letter.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">2</div>
                  <div className="step-content"><strong>Medical & Documentation:</strong> Complete your required medical tests in India and gather your financial documents (bank statements showing approx $5,000 - $6,000).</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">3</div>
                  <div className="step-content"><strong>Courier Documents:</strong> You must send the physical hard copies of all your required documents to your institute in Mauritius via international courier.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">4</div>
                  <div className="step-content"><strong>Visa Filing & Approval:</strong> Once received, the institute formally applies for your visa at the PIO in Mauritius on your behalf. The PIO issues a provisional student visa approval letter with a near 100% success rate.</div>
                </div>
                <div className="timeline-step">
                  <div className="step-num">5</div>
                  <div className="step-content"><strong>Travel & Final Endorsement:</strong> You travel to Mauritius with the provisional letter, complete a quick post-arrival medical check, and receive your final visa endorsement.</div>
                </div>
              </div>
            </div>
            ...
            <div id="documents" className="scroll-section">
              ...
              <p>Because the visa process does not require IELTS or interviews, ensuring your paperwork is neat and accurate is the only requirement for success.</p>
              
              <h3>Required Admission & Visa Documents</h3>
              <ul className="doc-list">
                <li>Valid Passport (Front & Back scanned clearly)</li>
                <li>All Academic Transcripts & Certificates (10th, 12th, Bachelor's)</li>
                <li>Original Medical Certificate (As per Mauritius PIO format)</li>
                <li>Bank Statement showing latest funds (approx USD 5,000 - 6,000)</li>
                <li>Sponsorship Letter (If parents are funding the education)</li>
                <li>Passport-sized Photographs</li>
                <li>Updated Curriculum Vitae (CV)</li>
              </ul>

              <div className="content-highlight">
                <p><strong>No English Tests Required:</strong> You do NOT need to submit an IELTS, PTE, or TOEFL scorecard for your application or visa processing in Mauritius.</p>
              </div>
            </div>
            ...
            <div id="careers" className="scroll-section">
              ...
              <p>Mauritius provides excellent opportunities to gain international work experience, particularly within its world-renowned service and hospitality sectors.</p>
              
              <h3>Part-Time Work During Studies</h3>
              <p>International students in Mauritius are legally permitted to work part-time for up to <strong>20 hours per week</strong>. This allows students to comfortably manage their monthly living expenses while studying.</p>

              <h3>Internship Opportunities</h3>
              <p>While not universally guaranteed, a few specific programs in Hospitality and Tourism feature internships. These selective opportunities allow students to gain practical, hands-on experience within the island's renowned service sector.</p>
            </div>
            ...
            <div id="faqs" className="scroll-section">
              ...
              <div className="faq-card">
                <h4>Is it true that the visa approval rate is almost 100%?</h4>
                <p>Yes. Because the educational institute applies directly to the immigration office on your behalf—and there are no subjective embassy interviews or strict IELTS requirements—genuine students with the correct funds experience a near 100% visa success rate.</p>
              </div>
              
              <div className="faq-card">
                <h4>Can I transfer my credits to another country later?</h4>
                <p>Absolutely. Many institutes in Mauritius have strong tie-ups with universities in the UK, Europe, and Australia. You can easily complete your diploma or first two years in Mauritius and transfer to a Western country for your final year.</p>
              </div>

              <div className="faq-card">
                <h4>Exactly how much money do I need to show in the bank?</h4>
                <p>To satisfy the Passport and Immigration Office (PIO), you or your sponsor must show a bank statement reflecting the latest funds equivalent to approximately USD 5,000 to USD 6,000.</p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#4B5563", margin: 0, maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
              Every country offers unique opportunities. Compare Mauritius with other top global study destinations to find your perfect fit.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, flex: "1 1 400px" }}>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 900, color: "white", letterSpacing: "-0.5px", margin: "0 0 16px" }}>
                Ready to Apply to Mauritius?
              </h2>
              <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.6, maxWidth: "480px" }}>
                Connect with our certified experts to secure your admission letter, prepare your financial documents, and successfully lodge your Mauritius Study Visa.
              </p>
            </div>
