...
const faqs = [
  { q: "Can Rajkot students get a consultation from Edification Overseas?", a: "Yes. We offer free online consultations for Rajkot students and welcome in-person visits to our Ahmedabad office at Sun West Bank, Ashram Road. Call +91 87994 50049 to schedule." },
  { q: "Which countries are most popular for Rajkot students?", a: "UK, Canada, Singapore, and Germany are the most popular. Many Rajkot students also choose Cyprus and Malta for affordable EU degrees. Our counsellors suggest the best fit based on your profile and budget." },
  { q: "Is IELTS mandatory for students from Rajkot?", a: "Not always. Singapore waives IELTS for English-medium students. Cyprus and Malta also accept alternatives. We assess your profile individually and find the best path forward." },
  { q: "What is the minimum investment to study abroad from Rajkot?", a: "Students can study in Cyprus or Mauritius for as low as ₹6–8 lakhs per year. For UK and Canada, budgets typically start from ₹20 lakhs per year. We tailor options to your financial capacity." },
  { q: "Does Edification Overseas help Rajkot students from Saurashtra universities?", a: "Yes. Students from Saurashtra University, RK University, and other Rajkot institutions have been successfully placed by us. Strong academic profiles from any recognized university qualify." },
];
    ...
    <main style={{ background: "#F9FAFB", overflowX: "hidden" }}>
      ...
      <section className="city-hero">
        ...
        <div ref={heroRef.ref} style={{ maxWidth:"1280px", margin:"0 auto", position:"relative", zIndex:1 }}>
          <nav className="breadcrumb">
            ...
            <span style={{ color:"#07CBEB" }}>Study Abroad Consultants in Rajkot</span>
          </nav>
          <div style={{ maxWidth:"760px" }}>
            <div style={{ display:"inline-flex", alignItems:"center", gap:"8px", background:"rgba(255,255,255,0.05)", border:"1px solid rgba(255,255,255,0.1)", borderRadius:"999px", padding:"6px 16px", marginBottom:"20px" }}>
              ...
              <span style={{ fontSize:"12px", fontWeight:800, color:"rgba(255,255,255,0.9)", letterSpacing:"0.4px", textTransform:"uppercase" }}>📍 Serving Rajkot &amp; Saurashtra, Gujarat</span>
            </div>
            ...
            <p style={{ fontSize:"clamp(15px,1.8vw,17px)", color:"rgba(255,255,255,0.85)", lineHeight:1.7, marginBottom:"36px", maxWidth:"600px" }}>
              Edification Overseas is Gujarat&apos;s most trusted ICEF-accredited overseas education consultancy. We proudly serve students from Rajkot and across Saurashtra, helping them secure admissions and visas at top universities in the UK, Canada, Singapore, Germany and 30+ more countries.
            </p>
      ...
      <div style={{ maxWidth:"1280px", margin:"0 auto", padding:"48px 24px 80px" }}>
        ...
        <div className="city-section">
          <h2>Overseas Education for Rajkot &amp; Saurashtra Students</h2>
          <p>Rajkot is the commercial heart of Saurashtra — and its students are increasingly looking beyond India for world-class education and global career opportunities. Whether you are a fresh graduate from Saurashtra University or an engineering student from RK University, Edification Overseas is your trusted partner for the entire journey — from profile assessment to visa approval.</p>
          <p>We offer the same <strong>ICEF-accredited, 5.0★-rated service</strong> to Rajkot students as we do to our Ahmedabad walk-ins — with free online consultations available for students who cannot travel to our office.</p>
        ...
        <div className="city-section">
          <h2>Top Study Destinations for Rajkot Students</h2>
          <p>Explore the countries where Rajkot students are building successful global careers. Click any country to read the complete visa guide, university list, and career pathways.</p>
        ...
        <div className="city-section">
          <h2>Frequently Asked Questions — Rajkot Students</h2>
        ...
        <div className="cta-banner">
          ...
          <div style={{ position:"relative", zIndex:1, flex:"1 1 400px" }}>
            <h2 style={{ fontSize:"clamp(24px,3vw,32px)", fontWeight:900, color:"white", margin:"0 0 12px", letterSpacing:"-0.5px" }}>Rajkot Student? Let&apos;s Build Your Global Future.</h2>
            <p style={{ fontSize:"15px", color:"rgba(255,255,255,0.75)", margin:0, lineHeight:1.6, maxWidth:"480px" }}>Free online or in-person consultation. ICEF-accredited counsellors. 98% visa success rate. Call +91 87994 50049 or book online.</p>
          </div>
